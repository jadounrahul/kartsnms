...
namespace KartsNMS\Device;

use KartsNMS\Config;
use KartsNMS\Interfaces\Discovery\DiscoveryModule;
use KartsNMS\Interfaces\Polling\PollerModule;
use KartsNMS\OS;
...
class Sensor implements DiscoveryModule, PollerModule
{
    ...
    {
        return StringHelpers::toClass($type, 'KartsNMS\\Interfaces\\Discovery\\Sensors\\') . 'Discovery';
    }
    ...
    {
        return StringHelpers::toClass($type, 'KartsNMS\\Interfaces\\Polling\\Sensors\\') . 'Polling';
    }
