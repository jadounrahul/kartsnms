...
if ($vars['metric'] == 'overview') {
    foreach ($datas as $type) {
        ...
        include \KartsNMS\Config::get('install_dir') . '/includes/html/print-device-graph.php';
    }
    ...
    foreach ($sensors as $sensor) {
        ...
        include \KartsNMS\Config::get('install_dir') . '/includes/html/print-graphrow.inc.php';
