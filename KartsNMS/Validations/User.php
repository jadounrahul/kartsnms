...
class User extends BaseValidation
{
    ...
    public function validate(Validator $validator): void
    {
        ...
        $lnms_username = \config('kartsnms.user');
        $lnms_groupname = \config('kartsnms.group');
            ...
            if (! Config::get('installed_from_package')) {
                ...
                if (! empty($find_result)) {
                    ...
                    $ignore_files = [
                        ...
                        "$dir/.pki/", // ignore files/folders created by setting the kartsnms home directory to the install directory
                    ];
