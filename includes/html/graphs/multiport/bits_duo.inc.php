...
$rrd_options .= \KartsNMS\Config::get('rrdgraph_def_text') . ' -c FONT#' . ltrim(\KartsNMS\Config::get('rrdgraph_def_text_color'), '#');
if ($height < '99') {
...
if ($width <= '300') {
    $rrd_options .= ' --font LEGEND:7:' . \KartsNMS\Config::get('mono_font') . ' --font AXIS:6:' . \KartsNMS\Config::get('mono_font') . ' --font-render-mode normal';
}
