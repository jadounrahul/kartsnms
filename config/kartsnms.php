 ...
 */
 ...
 return [
     ...
     |--------------------------------------------------------------------------
     |
     | This value is the user KartsNMS runs as. It is used to secure permissions
     | and grant access to things needed. Defaults to kartsnms.
     */

     'user' => env('LIBRENMS_USER', 'kartsnms'),
     ...
     |--------------------------------------------------------------------------
     |
     | This value is the group KartsNMS runs as. It is used to secure permissions
     | and grant access to things needed. Defaults to the same as LIBRENMS_USER.
     */

     'group' => env('LIBRENMS_GROUP', env('LIBRENMS_USER', 'kartsnms')),
