    ...
    <table id="mac-search" class="table table-hover table-condensed table-striped">
        <thead>
            <tr>
                ...
                <th data-column-id="mac_oui" data-sortable="false" data-width="150px" data-visible="<?php echo \KartsNMS\Config::get('mac_oui.enabled') ? 'true' : 'false' ?>" data-formatter="tooltip">Vendor</th>
