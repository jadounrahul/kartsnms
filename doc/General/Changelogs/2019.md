...
* Fix raisecom fan speed sensor limits ([#10930](https://github.com/jadounrahul/kartsnms/pull/10930)) - [vitalisator](https://github.com/vitalisator)
...
* Fix some IE issues with settings page ([#10819](https://github.com/jadounrahul/kartsnms/pull/10819)) - [murrant](https://github.com/murrant)
...
* Consolidate configuration settings and implement dynamic webui settings ([#9809](https://github.com/jadounrahul/kartsnms/pull/9809)) - [murrant](https://github.com/murrant)
...
* Updated Fast-Ping-Check documentation for distributed pollers ([#10575](https://github.com/jadounrahul/kartsnms/pull/10575)) - [garysteers](https://github.com/garysteers)
...
* Nfdump support for with NFSen ([#10376](https://github.com/jadounrahul/kartsnms/pull/10376)) - [VVelox](https://github.com/VVelox)
...
* Set Service Ignore and Disabled in UI ([#10334](https://github.com/jadounrahul/kartsnms/pull/10334)) - [h-barnhart](https://github.com/h-barnhart)
...
* Only allow mysql auth type to add users ([#10283](https://github.com/jadounrahul/kartsnms/pull/10283)) - [murrant](https://github.com/murrant)
...
* Add support for PoE state sensor on Mikrotik devices ([#10201](https://github.com/jadounrahul/kartsnms/pull/10201)) - [CirnoT](https://github.com/CirnoT)
...
* Fix aruba-controller polling ([#10071](https://github.com/jadounrahul/kartsnms/pull/10071)) - [twilley](https://github.com/twilley)
* Added device WISI Tangram ([#10039](https://github.com/jadounrahul/kartsnms/pull/10039)) - [djamp42](https://github.com/djamp42)
* Added PPPoE Sessions Graph for Mikrotik ([#10056](https://github.com/jadounrahul/kartsnms/pull/10056)) - [neszt](https://github.com/neszt)
* Fix gw-eydfa detection ([#10052](https://github.com/jadounrahul/kartsnms/pull/10052)) - [murrant](https://github.com/murrant)
* Added support for IONODES video encoders ([#10031](https://github.com/jadounrahul/kartsnms/pull/10031)) - [priiduonu](https://github.com/priiduonu)
* Added support for DELLEMC-OS10-PRODUCTS-MIB (os: dell-os10) ([#10011](https://github.com/jadounrahul/kartsnms/pull/10011)) - [spencerbutler](https://github.com/spencerbutler)

#### Bug
* Store IPv4 networks as network address and fix address search page showing networks not addresses ([#10144](https://github.com/jadounrahul/kartsnms/pull/10144)) - [CirnoT](https://github.com/CirnoT)
* Fix filter by device and interface type on IP address search page ([#10143](https://github.com/jadounrahul/kartsnms/pull/10143)) - [CirnoT](https://github.com/CirnoT)
* Fix services with scripts inheriting DS from previous service on detail view ([#10142](https://github.com/jadounrahul/kartsnms/pull/10142)) - [CirnoT](https://github.com/CirnoT)
* Fix call to shortDisplayName on null in MuninPluginController ([#10126](https://github.com/jadounrahul/kartsnms/pull/10126)) - [CirnoT](https://github.com/CirnoT)
* Fix install.php can't find config.php ([#10129](https://github.com/jadounrahul/kartsnms/pull/10129)) - [murrant](https://github.com/murrant)
* Fix call to isUnderMaintenance() on null ([#10090](https://github.com/jadounrahul/kartsnms/pull/10090)) - [murrant](https://github.com/murrant)
* Don't require db for config_to_json.php ([#10100](https://github.com/jadounrahul/kartsnms/pull/10100)) - [murrant](https://github.com/murrant)
* Bug - Nasty user_func vs divisor-multiplier issue ([#10122](https://github.com/jadounrahul/kartsnms/pull/10122)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix to display minimum values in uptime graphs. ([#10078](https://github.com/jadounrahul/kartsnms/pull/10078)) - [Slushnas](https://github.com/Slushnas)
* Fix notification creation ([#10058](https://github.com/jadounrahul/kartsnms/pull/10058)) - [murrant](https://github.com/murrant)
* Fixed fail2ban jails eventlog spam ([#10061](https://github.com/jadounrahul/kartsnms/pull/10061)) - [murrant](https://github.com/murrant)

#### Webui
* Easily setting font colors for RRD graphs is now possible ([#10083](https://github.com/jadounrahul/kartsnms/pull/10083)) - [VVelox](https://github.com/VVelox)
* New User Management ([#9348](https://github.com/jadounrahul/kartsnms/pull/9348)) - [murrant](https://github.com/murrant)
* Display number of connections for ASA on over ([#10106](https://github.com/jadounrahul/kartsnms/pull/10106)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix to display minimum values in uptime graphs. ([#10078](https://github.com/jadounrahul/kartsnms/pull/10078)) - [Slushnas](https://github.com/Slushnas)
* Refactored Nvidia Application ([#10037](https://github.com/jadounrahul/kartsnms/pull/10037)) - [tim427](https://github.com/tim427)
* Improve Huawei BGP polling + BGP webui & graphs patches ([#10010](https://github.com/jadounrahul/kartsnms/pull/10010)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix notification creation ([#10058](https://github.com/jadounrahul/kartsnms/pull/10058)) - [murrant](https://github.com/murrant)
* Add SysName to Oxidized view ([#10012](https://github.com/jadounrahul/kartsnms/pull/10012)) - [smiles1969](https://github.com/smiles1969)

#### Documentation
* Updated Code-Structure.md ([#10156](https://github.com/jadounrahul/kartsnms/pull/10156)) - [pobradovic08](https://github.com/pobradovic08)
* Fix formatting ([#10135](https://github.com/jadounrahul/kartsnms/pull/10135)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Fix paths of custom graph examples in Custom-Graphs.md ([#10128](https://github.com/jadounrahul/kartsnms/pull/10128)) - [pobradovic08](https://github.com/pobradovic08)
* Update Example-Hardware-Setup.md ([#10115](https://github.com/jadounrahul/kartsnms/pull/10115)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Update Templates.md ([#10120](https://github.com/jadounrahul/kartsnms/pull/10120)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Example Hardware - corrected markup ([#10117](https://github.com/jadounrahul/kartsnms/pull/10117)) - [cppmonkey](https://github.com/cppmonkey)
* Minor word usage corrections ([#10073](https://github.com/jadounrahul/kartsnms/pull/10073)) - [andrewimeson](https://github.com/andrewimeson)
* Update Smokeping.md ([#10064](https://github.com/jadounrahul/kartsnms/pull/10064)) - [mattie47](https://github.com/mattie47)
* Update SNMP-Configuration-Examples ([#10063](https://github.com/jadounrahul/kartsnms/pull/10063)) - [dmeiser](https://github.com/dmeiser)
* KartsNMS python service doc updates ([#10044](https://github.com/jadounrahul/kartsnms/pull/10044)) - [murrant](https://github.com/murrant)

#### Api
* Allow Add_Device API to set sysName ([#10124](https://github.com/jadounrahul/kartsnms/pull/10124)) - [djamp42](https://github.com/djamp42)
* Fix api *log date format ([#10133](https://github.com/jadounrahul/kartsnms/pull/10133)) - [murrant](https://github.com/murrant)
* Fix arp api network query ([#10085](https://github.com/jadounrahul/kartsnms/pull/10085)) - [murrant](https://github.com/murrant)
* Fixed a duplicate route name in the api ([#10082](https://github.com/jadounrahul/kartsnms/pull/10082)) - [laf](https://github.com/laf)
* Add API call to list all ports FDB ([#10020](https://github.com/jadounrahul/kartsnms/pull/10020)) - [zombah](https://github.com/zombah)
* Added slms => zhoneolt mapping for Oxidized model ([#10068](https://github.com/jadounrahul/kartsnms/pull/10068)) - [laf](https://github.com/laf)

#### Alerting
* Relax validation for smseagle hostname ([#10141](https://github.com/jadounrahul/kartsnms/pull/10141)) - [petracvv](https://github.com/petracvv)
* Removed legacy code from transports ([#10081](https://github.com/jadounrahul/kartsnms/pull/10081)) - [laf](https://github.com/laf)

#### Security
* Fix unescaped variables in ajax_search.php ([#10088](https://github.com/jadounrahul/kartsnms/pull/10088)) - [murrant](https://github.com/murrant)
* Security fix: unauthorized access ([#10091](https://github.com/jadounrahul/kartsnms/pull/10091)) - [murrant](https://github.com/murrant)

#### Feature
* Update json error message to show how to debug. ([#9998](https://github.com/jadounrahul/kartsnms/pull/9998)) - [murrant](https://github.com/murrant)
...
#### Feature
* Printer paper tray status and error states ([#9859](https://github.com/jadounrahul/kartsnms/pull/9859)) - [sjtarik](https://github.com/sjtarik)
* Added support for custom storage warning percentage ([#9975](https://github.com/jadounrahul/kartsnms/pull/9975)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Added support for ciscosb to gen_rancid.php (cisco-sb) ([#9940](https://github.com/jadounrahul/kartsnms/pull/9940)) - [cliffalbert](https://github.com/cliffalbert)
* Access to "sub" index (when OID has multiple indexes) ([#9893](https://github.com/jadounrahul/kartsnms/pull/9893)) - [PipoCanaja](https://github.com/PipoCanaja)
* Optional automatic sensor limits ([#9973](https://github.com/jadounrahul/kartsnms/pull/9973)) - [amigne](https://github.com/amigne)

#### Bug
* Fix database validation for MySQL 8 ([#9923](https://github.com/jadounrahul/kartsnms/pull/9923)) - [llcoolkm](https://github.com/llcoolkm)
* Fixed device missing from traps/new Log::event() ([#9963](https://github.com/jadounrahul/kartsnms/pull/9963)) - [murrant](https://github.com/murrant)
* Fixed Cisco OTV (array)cast issue creating empty adj. ([#9968](https://github.com/jadounrahul/kartsnms/pull/9968)) - [PipoCanaja](https://github.com/PipoCanaja)
* Improved support for Dantel Webmon ([#9977](https://github.com/jadounrahul/kartsnms/pull/9977)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fixed inconsistent \<h3\> closed by \</div\> ([#9982](https://github.com/jadounrahul/kartsnms/pull/9982)) - [amigne](https://github.com/amigne)
* Fixed install not connecting to DB ([#9984](https://github.com/jadounrahul/kartsnms/pull/9984)) - [murrant](https://github.com/murrant)
* Fixed mysql table engine validation ([#9989](https://github.com/jadounrahul/kartsnms/pull/9989)) - [murrant](https://github.com/murrant)
* Fixed device list down devices that have never been polled ([#9994](https://github.com/jadounrahul/kartsnms/pull/9994)) - [murrant](https://github.com/murrant)
* Fixed world map when location has been deleted that a device still references ([#9997](https://github.com/jadounrahul/kartsnms/pull/9997)) - [murrant](https://github.com/murrant)
* Fixed device group queries again ([#10000](https://github.com/jadounrahul/kartsnms/pull/10000)) - [murrant](https://github.com/murrant)
* Fixed transport options when edited on Windows ([#10001](https://github.com/jadounrahul/kartsnms/pull/10001)) - [murrant](https://github.com/murrant)
* Fixed issue with new permissions code ([#10004](https://github.com/jadounrahul/kartsnms/pull/10004)) - [murrant](https://github.com/murrant)
* Fixed bill permissions ([#10005](https://github.com/jadounrahul/kartsnms/pull/10005)) - [murrant](https://github.com/murrant)
* Fixed an issue with bills with no data ([#10009](https://github.com/jadounrahul/kartsnms/pull/10009)) - [murrant](https://github.com/murrant)
* Fixed error when user doesn't exist ([#10023](https://github.com/jadounrahul/kartsnms/pull/10023)) - [murrant](https://github.com/murrant)
* Top ports widget: Work around bad data in the database ([#10024](https://github.com/jadounrahul/kartsnms/pull/10024)) - [murrant](https://github.com/murrant)
* Properly set the component information when polling ([#10017](https://github.com/jadounrahul/kartsnms/pull/10017)) - [VVelox](https://github.com/VVelox)
* Removed an errant character in cambium definitions ([#9996](https://github.com/jadounrahul/kartsnms/pull/9996)) - [spencerbutler](https://github.com/spencerbutler)
* Fixed cisco temperature limit on discovery ([#9985](https://github.com/jadounrahul/kartsnms/pull/9985)) - [amigne](https://github.com/amigne)
* Patch fix sql error on gengroupsql ([#9929](https://github.com/jadounrahul/kartsnms/pull/9929)) - [dracmic](https://github.com/dracmic)
* Work around issue with Weathermaps ([#10033](https://github.com/jadounrahul/kartsnms/pull/10033)) - [murrant](https://github.com/murrant)
* Typo in routeros YAML discovery ([#9903](https://github.com/jadounrahul/kartsnms/pull/9903)) - [PipoCanaja](https://github.com/PipoCanaja)
* Don't enable secure cookies when they won't work ([#9971](https://github.com/jadounrahul/kartsnms/pull/9971)) - [murrant](https://github.com/murrant)
* Do not use $sensor[sensor_limit] if not available ([#9978](https://github.com/jadounrahul/kartsnms/pull/9978)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix an issue that could block install ([#9958](https://github.com/jadounrahul/kartsnms/pull/9958)) - [murrant](https://github.com/murrant)
* Handle missing fields a little more gracefully ([#9919](https://github.com/jadounrahul/kartsnms/pull/9919)) - [murrant](https://github.com/murrant)
* Fix ldap/ad auth anon-bind ([#9905](https://github.com/jadounrahul/kartsnms/pull/9905)) - [murrant](https://github.com/murrant)
* Replace misplaced nokia/OSPFV3-MIB with a newer version to right place ([#9907](https://github.com/jadounrahul/kartsnms/pull/9907)) - [vitalisator](https://github.com/vitalisator)
* Fixes to composer_wrapper proxy handling ([#9819](https://github.com/jadounrahul/kartsnms/pull/9819)) - [murrant](https://github.com/murrant)
* Allow admins to add/remove/create sticky notifications ([#9865](https://github.com/jadounrahul/kartsnms/pull/9865)) - [cppmonkey](https://github.com/cppmonkey)

#### Device
* Improve VRP stack state discovery with one member only to avoid unnecessary alarms ([#9925](https://github.com/jadounrahul/kartsnms/pull/9925)) - [PipoCanaja](https://github.com/PipoCanaja)
* Improved Riello UPS support with RFC 1628 support ([#9962](https://github.com/jadounrahul/kartsnms/pull/9962)) - [PipoCanaja](https://github.com/PipoCanaja)
* Improved support for Dantel Webmon ([#9977](https://github.com/jadounrahul/kartsnms/pull/9977)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added Arris Apex support ([#10006](https://github.com/jadounrahul/kartsnms/pull/10006)) - [djamp42](https://github.com/djamp42)
* Added Panduit Eagle-I (was Sinetica) support ([#10014](https://github.com/jadounrahul/kartsnms/pull/10014)) - [PipoCanaja](https://github.com/PipoCanaja)
* Eltek Valere: Group sensors by shelf ([#10040](https://github.com/jadounrahul/kartsnms/pull/10040)) - [murrant](https://github.com/murrant)
* Added support for APC AP9810 zone contacts ([#9967](https://github.com/jadounrahul/kartsnms/pull/9967)) - [cppmonkey](https://github.com/cppmonkey)
* Added support for HikVision-DS Cameras ([#9980](https://github.com/jadounrahul/kartsnms/pull/9980)) - [spencerbutler](https://github.com/spencerbutler)
* Added support for EDFA ([#9912](https://github.com/jadounrahul/kartsnms/pull/9912)) - [jozefrebjak](https://github.com/jozefrebjak)
* Added support for Orvaldi UPS ([#10021](https://github.com/jadounrahul/kartsnms/pull/10021)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added support for Ruijie Networks ([#10026](https://github.com/jadounrahul/kartsnms/pull/10026)) - [spencerbutler](https://github.com/spencerbutler)
* Extend support for all emerson products ([#10018](https://github.com/jadounrahul/kartsnms/pull/10018)) - [PipoCanaja](https://github.com/PipoCanaja)
* New Device: ATS - Automatic Transfer Switch ([#9889](https://github.com/jadounrahul/kartsnms/pull/9889)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Add Device - Cisco Sat Receivers ([#9899](https://github.com/jadounrahul/kartsnms/pull/9899)) - [djamp42](https://github.com/djamp42)
* Add Device Arris DSR-4410MD Sat Receiver ([#9943](https://github.com/jadounrahul/kartsnms/pull/9943)) - [djamp42](https://github.com/djamp42)
* Added Med(5m) and High(15m) Utilization sensors for Cambium  APs (os: pmp) ([#9995](https://github.com/jadounrahul/kartsnms/pull/9995)) - [spencerbutler](https://github.com/spencerbutler)
* Grandstream basic support ([#9906](https://github.com/jadounrahul/kartsnms/pull/9906)) - [PipoCanaja](https://github.com/PipoCanaja)
* Dell UPS enable rfc 1628 support ([#9961](https://github.com/jadounrahul/kartsnms/pull/9961)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added support for Cisco Small Business WAP371-a-k9 ([#9974](https://github.com/jadounrahul/kartsnms/pull/9974)) - [spencerbutler](https://github.com/spencerbutler)
* Dantel WebMon Device Support ([#9767](https://github.com/jadounrahul/kartsnms/pull/9767)) - [network-guy](https://github.com/network-guy)
* Added new OS - sensatronics-em1 ([#9960](https://github.com/jadounrahul/kartsnms/pull/9960)) - [spencerbutler](https://github.com/spencerbutler)
* Eaton pdu extension ([#9947](https://github.com/jadounrahul/kartsnms/pull/9947)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix Aruba Instant wireless sensors ([#9936](https://github.com/jadounrahul/kartsnms/pull/9936)) - [murrant](https://github.com/murrant)
* Added Ciena Waveserver ([#9930](https://github.com/jadounrahul/kartsnms/pull/9930)) - [PipoCanaja](https://github.com/PipoCanaja)
* Add Junos VirtuallChassis ports polling ([#9879](https://github.com/jadounrahul/kartsnms/pull/9879)) - [rmagomedov](https://github.com/rmagomedov)
* Add support for Moxa EDS-G512E-8PoE ([#9857](https://github.com/jadounrahul/kartsnms/pull/9857)) - [priiduonu](https://github.com/priiduonu)
* Improved Infinera Groove discovery ([#9913](https://github.com/jadounrahul/kartsnms/pull/9913)) - [nickhilliard](https://github.com/nickhilliard)
* Add support for power supply on Extreme BOSS switches ([#9898](https://github.com/jadounrahul/kartsnms/pull/9898)) - [ospfbgp](https://github.com/ospfbgp)
* Add support for cirpack soft switch ([#9914](https://github.com/jadounrahul/kartsnms/pull/9914)) - [vitalisator](https://github.com/vitalisator)
* Added VRP stack member and ports discovery ([#9891](https://github.com/jadounrahul/kartsnms/pull/9891)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added Patton SmartNode OS discovery and polling ([#9901](https://github.com/jadounrahul/kartsnms/pull/9901)) - [PipoCanaja](https://github.com/PipoCanaja)
* Meraki MS: add serial number ([#9768](https://github.com/jadounrahul/kartsnms/pull/9768)) - [GitStoph](https://github.com/GitStoph)
* Add data scrubbing state to Synology RAID status ([#9661](https://github.com/jadounrahul/kartsnms/pull/9661)) - [florianbeer](https://github.com/florianbeer)
* Add support for Infinera-Coriant Groove ([#9843](https://github.com/jadounrahul/kartsnms/pull/9843)) - [nickhilliard](https://github.com/nickhilliard)

#### Webui
* Allowed more characters in graph legend for interface names ([#9926](https://github.com/jadounrahul/kartsnms/pull/9926)) - [PipoCanaja](https://github.com/PipoCanaja)
* Corrected active_count for Alert icon color ([#9933](https://github.com/jadounrahul/kartsnms/pull/9933)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fixed inconsistent \<h3\> closed by \</div\> ([#9982](https://github.com/jadounrahul/kartsnms/pull/9982)) - [amigne](https://github.com/amigne)
* Fixed world map when location has been deleted that a device still references ([#9997](https://github.com/jadounrahul/kartsnms/pull/9997)) - [murrant](https://github.com/murrant)
* Improved Health limits display ([#10007](https://github.com/jadounrahul/kartsnms/pull/10007)) - [amigne](https://github.com/amigne)
* Added Panduit Eagle-I (was Sinetica) support ([#10014](https://github.com/jadounrahul/kartsnms/pull/10014)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fixed missing pipe in ports page menu ([#10025](https://github.com/jadounrahul/kartsnms/pull/10025)) - [JoshWeepie](https://github.com/JoshWeepie)
* Added location to alert hostname tooltip ([#9991](https://github.com/jadounrahul/kartsnms/pull/9991)) - [rmedlyn](https://github.com/rmedlyn)
* Beautify port health ([#9981](https://github.com/jadounrahul/kartsnms/pull/9981)) - [amigne](https://github.com/amigne)
* Added a blue theme ([#9970](https://github.com/jadounrahul/kartsnms/pull/9970)) - [PipoCanaja](https://github.com/PipoCanaja)
* Display Up/Down time in Device List ([#9951](https://github.com/jadounrahul/kartsnms/pull/9951)) - [PipoCanaja](https://github.com/PipoCanaja)
* Add Alert-transports to Laravel menu blade ([#9946](https://github.com/jadounrahul/kartsnms/pull/9946)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix graphs for ASA announcing all interfaces in type l2vlan (by default filtered) ([#9849](https://github.com/jadounrahul/kartsnms/pull/9849)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix widgets page with MySQL 8 ([#9922](https://github.com/jadounrahul/kartsnms/pull/9922)) - [llcoolkm](https://github.com/llcoolkm)
* Fixed sysName can't display because newline character ([#9921](https://github.com/jadounrahul/kartsnms/pull/9921)) - [jasoncheng7115](https://github.com/jasoncheng7115)
* Allow admins to add/remove/create sticky notifications ([#9865](https://github.com/jadounrahul/kartsnms/pull/9865)) - [cppmonkey](https://github.com/cppmonkey)

#### Alerting
* Added HTML transport example for ms teams ([#9969](https://github.com/jadounrahul/kartsnms/pull/9969)) - [sorano](https://github.com/sorano)
* Fixed device group queries again ([#10000](https://github.com/jadounrahul/kartsnms/pull/10000)) - [murrant](https://github.com/murrant)
* Fixed transport options when edited on Windows ([#10001](https://github.com/jadounrahul/kartsnms/pull/10001)) - [murrant](https://github.com/murrant)
* Update documentation to reflect matching behaviour ([#9955](https://github.com/jadounrahul/kartsnms/pull/9955)) - [kiwibrew](https://github.com/kiwibrew)

#### Documentation
* Added HTML transport example for ms teams ([#9969](https://github.com/jadounrahul/kartsnms/pull/9969)) - [sorano](https://github.com/sorano)
* Fixed path in Smokeping conf file ([#10045](https://github.com/jadounrahul/kartsnms/pull/10045)) - [fjwcash](https://github.com/fjwcash)
* Update Fast-Ping-Check.md ([#10022](https://github.com/jadounrahul/kartsnms/pull/10022)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Update documentation to reflect matching behaviour ([#9955](https://github.com/jadounrahul/kartsnms/pull/9955)) - [kiwibrew](https://github.com/kiwibrew)
* Update Getting-Started.md ([#9976](https://github.com/jadounrahul/kartsnms/pull/9976)) - [PipoCanaja](https://github.com/PipoCanaja)
* Documentation for setting a development environment ([#9944](https://github.com/jadounrahul/kartsnms/pull/9944)) - [murrant](https://github.com/murrant)
* Add new template syntax into the FAQ, pointing to the documentation ([#9942](https://github.com/jadounrahul/kartsnms/pull/9942)) - [PipoCanaja](https://github.com/PipoCanaja)
* Add Debian instruction ([#9788](https://github.com/jadounrahul/kartsnms/pull/9788)) - [koocotte](https://github.com/koocotte)
* Update Web UI debug FAQ ([#9816](https://github.com/jadounrahul/kartsnms/pull/9816)) - [murrant](https://github.com/murrant)

#### Security
* Update dependencies ([#10002](https://github.com/jadounrahul/kartsnms/pull/10002)) - [murrant](https://github.com/murrant)
* Prevent credentials from being leaked in backtrace in some instances ([#9817](https://github.com/jadounrahul/kartsnms/pull/9817)) - [murrant](https://github.com/murrant)

#### Api
* Added resources/sensors api call to list all sensors ([#9837](https://github.com/jadounrahul/kartsnms/pull/9837)) - [zombah](https://github.com/zombah)
...
#### Documentation
* Updated JumpCloud authentication example ([#9722](https://github.com/jadounrahul/kartsnms/pull/9722)) - [dsmfool](https://github.com/dsmfool)
* Additional info for Postgres application ([#9791](https://github.com/jadounrahul/kartsnms/pull/9791)) - [SirMaple](https://github.com/SirMaple)
* Update Example-Hardware-Setup.md ([#9897](https://github.com/jadounrahul/kartsnms/pull/9897)) - [cppmonkey](https://github.com/cppmonkey)
* Fix link missing parenthesis ([#9895](https://github.com/jadounrahul/kartsnms/pull/9895)) - [githubuserx](https://github.com/githubuserx)
* Added new install to example hardware setup ([#9872](https://github.com/jadounrahul/kartsnms/pull/9872)) - [SirMaple](https://github.com/SirMaple)
* Clarification in server migration procedure ([#9848](https://github.com/jadounrahul/kartsnms/pull/9848)) - [hlmtre](https://github.com/hlmtre)
* Update the bug report link in README.md ([#9850](https://github.com/jadounrahul/kartsnms/pull/9850)) - [kkrumm1](https://github.com/kkrumm1)
* Remove extra semicolon from documentation. ([#9833](https://github.com/jadounrahul/kartsnms/pull/9833)) - [tharbakim](https://github.com/tharbakim)
* Change minimum PHP version in install docs ([#9820](https://github.com/jadounrahul/kartsnms/pull/9820)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Install docs, note proxy config ([#9720](https://github.com/jadounrahul/kartsnms/pull/9720)) - [mhzgh](https://github.com/mhzgh)
* Fix Smokeping setup instructions so they actually work ([#9731](https://github.com/jadounrahul/kartsnms/pull/9731)) - [fake-name](https://github.com/fake-name)
* Fix a link in support document ([#9808](https://github.com/jadounrahul/kartsnms/pull/9808)) - [paraselene92](https://github.com/paraselene92)
* Update Poller Support.md ([#9769](https://github.com/jadounrahul/kartsnms/pull/9769)) - [TheGreatDoc](https://github.com/TheGreatDoc)

#### Device
* Ruckus Wireless updates (ZD/SZ/Unleashed/Hotzone) ([#9727](https://github.com/jadounrahul/kartsnms/pull/9727)) - [djamp42](https://github.com/djamp42)
* Fix Arista interface bias current divisor ([#9728](https://github.com/jadounrahul/kartsnms/pull/9728)) - [Rosiak](https://github.com/Rosiak)
* Added power and fan sensors to VRP ([#9838](https://github.com/jadounrahul/kartsnms/pull/9838)) - [jozefrebjak](https://github.com/jozefrebjak)
* [fix] edgeswitch v1.9 os detection ([#9868](https://github.com/jadounrahul/kartsnms/pull/9868)) - [crcro](https://github.com/crcro)
* Add support for sagemcom ([#9835](https://github.com/jadounrahul/kartsnms/pull/9835)) - [vitalisator](https://github.com/vitalisator)
* Add fan description to hwEntityFanState ([#9863](https://github.com/jadounrahul/kartsnms/pull/9863)) - [PipoCanaja](https://github.com/PipoCanaja)
* [feat] edgeos hardware info ([#9867](https://github.com/jadounrahul/kartsnms/pull/9867)) - [crcro](https://github.com/crcro)
* Added support for Alpha Comp@s ([#9871](https://github.com/jadounrahul/kartsnms/pull/9871)) - [cppmonkey](https://github.com/cppmonkey)
* Discovery rcChasPowerSupplyOperStatus for Extreme/Avaya voss.inc.php stop working ([#9878](https://github.com/jadounrahul/kartsnms/pull/9878)) - [ospfbgp](https://github.com/ospfbgp)
* Added Perle OS Support for IOLAN SCS ([#9866](https://github.com/jadounrahul/kartsnms/pull/9866)) - [esundberg](https://github.com/esundberg)
* Netscaler SDWAN appliance - Serial# + Version and state sensors ([#9834](https://github.com/jadounrahul/kartsnms/pull/9834)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added support for Protelevision DVB-T Transmitter ([#9648](https://github.com/jadounrahul/kartsnms/pull/9648)) - [jozefrebjak](https://github.com/jozefrebjak)
* Netgear m5300 health sensors ([#9744](https://github.com/jadounrahul/kartsnms/pull/9744)) - [cppmonkey](https://github.com/cppmonkey)
* Additional TPLink JetStream mem/cpu support ([#9829](https://github.com/jadounrahul/kartsnms/pull/9829)) - [TakeMeNL](https://github.com/TakeMeNL)
* MAIPU MyPowerOS: CPU, Memory, expanded detection ([#9825](https://github.com/jadounrahul/kartsnms/pull/9825)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Fix Junos CPU Discovery ([#9467](https://github.com/jadounrahul/kartsnms/pull/9467)) - [Rosiak](https://github.com/Rosiak)
* Add support for Nokia ISAM ([#9793](https://github.com/jadounrahul/kartsnms/pull/9793)) - [vitalisator](https://github.com/vitalisator)
* Updating pfSense Logo ([#9828](https://github.com/jadounrahul/kartsnms/pull/9828)) - [SirMaple](https://github.com/SirMaple)
* Expand Cyberpower OS detection ([#9802](https://github.com/jadounrahul/kartsnms/pull/9802)) - [murrant](https://github.com/murrant)
* Add osmc icon ([#9810](https://github.com/jadounrahul/kartsnms/pull/9810)) - [murrant](https://github.com/murrant)
* Workaround of bad SNMP implementation in EDS device. ([#9801](https://github.com/jadounrahul/kartsnms/pull/9801)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added Virtual Chassis Member Role Sensor ([#9783](https://github.com/jadounrahul/kartsnms/pull/9783)) - [ipptac](https://github.com/ipptac)
* FS.COM (Fiberstore) 'GBN' and 'SWITCH' devices support ([#9734](https://github.com/jadounrahul/kartsnms/pull/9734)) - [PipoCanaja](https://github.com/PipoCanaja)
* Support for DKT Comega FTTx devices ([#9732](https://github.com/jadounrahul/kartsnms/pull/9732)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added support for EDS 1Wire devices ([#9740](https://github.com/jadounrahul/kartsnms/pull/9740)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix regression in VC hardware detection for JunOS ([#9772](https://github.com/jadounrahul/kartsnms/pull/9772)) - [martijn-schmidt](https://github.com/martijn-schmidt)
* New Device: Bluecat Networks appliances ([#9758](https://github.com/jadounrahul/kartsnms/pull/9758)) - [ipptac](https://github.com/ipptac)

#### Alerting
* Fix Arista interface bias current divisor ([#9728](https://github.com/jadounrahul/kartsnms/pull/9728)) - [Rosiak](https://github.com/Rosiak)
* KartsNMS/Alert/Transport/Elasticsearch - Send timestamp with timezone ([#9757](https://github.com/jadounrahul/kartsnms/pull/9757)) - [pobradovic08](https://github.com/pobradovic08)
* Canopsis transport ([#9795](https://github.com/jadounrahul/kartsnms/pull/9795)) - [aylham](https://github.com/aylham)
* Alertmanager fix 2 ([#9860](https://github.com/jadounrahul/kartsnms/pull/9860)) - [angryp](https://github.com/angryp)
* Update Mattermost transport with configurable author_name ([#9759](https://github.com/jadounrahul/kartsnms/pull/9759)) - [zombah](https://github.com/zombah)
* Restore alert template converter for a while longer ([#9845](https://github.com/jadounrahul/kartsnms/pull/9845)) - [murrant](https://github.com/murrant)
* Removed legacy transports and templates code ([#9646](https://github.com/jadounrahul/kartsnms/pull/9646)) - [laf](https://github.com/laf)
* Fix cisco compenent down macro ([#9805](https://github.com/jadounrahul/kartsnms/pull/9805)) - [murrant](https://github.com/murrant)
* Fixed Alertmanager transport ([#9807](https://github.com/jadounrahul/kartsnms/pull/9807)) - [angryp](https://github.com/angryp)
* Msteams consistent title ([#9774](https://github.com/jadounrahul/kartsnms/pull/9774)) - [InsaneSplash](https://github.com/InsaneSplash)
* BGP Session down rule: add conditions for bgp admin status = stop ([#9773](https://github.com/jadounrahul/kartsnms/pull/9773)) - [Cormoran96](https://github.com/Cormoran96)

#### Bug
* More 278 fixes mysql 5.7 does not like the variable names ([#9766](https://github.com/jadounrahul/kartsnms/pull/9766)) - [murrant](https://github.com/murrant)
* Update to PHPMailer 6.0 (PHP 7.3 support) ([#9818](https://github.com/jadounrahul/kartsnms/pull/9818)) - [felici](https://github.com/felici)
* Syslog hostname translation broken ([#9839](https://github.com/jadounrahul/kartsnms/pull/9839)) - [TylerSweet](https://github.com/TylerSweet)
* Fix incorrect icon sometimes ([#9887](https://github.com/jadounrahul/kartsnms/pull/9887)) - [murrant](https://github.com/murrant)
* Try to fix some of the Component code ([#9888](https://github.com/jadounrahul/kartsnms/pull/9888)) - [murrant](https://github.com/murrant)
* Discovery rcChasPowerSupplyOperStatus for Extreme/Avaya voss.inc.php stop working ([#9878](https://github.com/jadounrahul/kartsnms/pull/9878)) - [ospfbgp](https://github.com/ospfbgp)
* Misplaced mib file when adding FS.COM support ([#9886](https://github.com/jadounrahul/kartsnms/pull/9886)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fixed validator for rrd folder permissions ([#9869](https://github.com/jadounrahul/kartsnms/pull/9869)) - [cppmonkey](https://github.com/cppmonkey)
* Fix MyPowerOS mempools ([#9861](https://github.com/jadounrahul/kartsnms/pull/9861)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Email should be optional in lnms user:add command ([#9841](https://github.com/jadounrahul/kartsnms/pull/9841)) - [murrant](https://github.com/murrant)
* Fix logging too much ([#9824](https://github.com/jadounrahul/kartsnms/pull/9824)) - [murrant](https://github.com/murrant)
* Fix for failed sql query during db dump ([#9815](https://github.com/jadounrahul/kartsnms/pull/9815)) - [murrant](https://github.com/murrant)
* Fix cisco compenent down macro ([#9805](https://github.com/jadounrahul/kartsnms/pull/9805)) - [murrant](https://github.com/murrant)
* Discard local changes to git based vendor packages ([#9813](https://github.com/jadounrahul/kartsnms/pull/9813)) - [murrant](https://github.com/murrant)
* Fixed Alertmanager transport ([#9807](https://github.com/jadounrahul/kartsnms/pull/9807)) - [angryp](https://github.com/angryp)
* Fix php version notification removal ([#9797](https://github.com/jadounrahul/kartsnms/pull/9797)) - [murrant](https://github.com/murrant)
* Fix php version notification removal ([#9796](https://github.com/jadounrahul/kartsnms/pull/9796)) - [murrant](https://github.com/murrant)
* Handle unexpected os when loading yaml ([#9790](https://github.com/jadounrahul/kartsnms/pull/9790)) - [murrant](https://github.com/murrant)
* Fix alert log api ([#9792](https://github.com/jadounrahul/kartsnms/pull/9792)) - [murrant](https://github.com/murrant)
* Fix schema validation and os def cache invalidation ([#9789](https://github.com/jadounrahul/kartsnms/pull/9789)) - [murrant](https://github.com/murrant)
* Restore gitignore file contents ([#9784](https://github.com/jadounrahul/kartsnms/pull/9784)) - [murrant](https://github.com/murrant)
* Port exists check in eventlog ([#9778](https://github.com/jadounrahul/kartsnms/pull/9778)) - [CoMMyz](https://github.com/CoMMyz)
* Migration fixes ([#9776](https://github.com/jadounrahul/kartsnms/pull/9776)) - [murrant](https://github.com/murrant)
* Prevent error with multiple proxmox ([#9770](https://github.com/jadounrahul/kartsnms/pull/9770)) - [murrant](https://github.com/murrant)

#### Webui
* Fix debug display of rrdtool command ([#9846](https://github.com/jadounrahul/kartsnms/pull/9846)) - [Anthony25](https://github.com/Anthony25)
* Ignore disabled ports in minigraph view ([#9737](https://github.com/jadounrahul/kartsnms/pull/9737)) - [mbwall](https://github.com/mbwall)

#### Feature
* Improved Exception handling ([#9844](https://github.com/jadounrahul/kartsnms/pull/9844)) - [murrant](https://github.com/murrant)
* FDB table with history capabilities ([#9804](https://github.com/jadounrahul/kartsnms/pull/9804)) - [PipoCanaja](https://github.com/PipoCanaja)
* Php artisan serve and dusk testing ([#9422](https://github.com/jadounrahul/kartsnms/pull/9422)) - [murrant](https://github.com/murrant)
* Lnms user:add command ([#9830](https://github.com/jadounrahul/kartsnms/pull/9830)) - [murrant](https://github.com/murrant)
...
#### Alerting
* Added Mattermost Alert Transport ([#9749](https://github.com/jadounrahul/kartsnms/pull/9749)) - [gpant](https://github.com/gpant)
* Added Alerta Alert Transport ([#9673](https://github.com/jadounrahul/kartsnms/pull/9673)) - [GitStoph](https://github.com/GitStoph)
* Fix first column validate ([#9683](https://github.com/jadounrahul/kartsnms/pull/9683)) - [murrant](https://github.com/murrant)
* Alert Rules: fix for critical and warning rule ([#9688](https://github.com/jadounrahul/kartsnms/pull/9688)) - [kkrumm1](https://github.com/kkrumm1)
* Added Alertmanager transport ([#9637](https://github.com/jadounrahul/kartsnms/pull/9637)) - [angryp](https://github.com/angryp)
* Fix wireless sensor edit messages and collection alert rule ([#9624](https://github.com/jadounrahul/kartsnms/pull/9624)) - [murrant](https://github.com/murrant)
* Alert schedule refactor ([#9514](https://github.com/jadounrahul/kartsnms/pull/9514)) - [murrant](https://github.com/murrant)

#### Feature
* Added Mattermost Alert Transport ([#9749](https://github.com/jadounrahul/kartsnms/pull/9749)) - [gpant](https://github.com/gpant)
* Pressing enter on global search goes to the first result ([#9587](https://github.com/jadounrahul/kartsnms/pull/9587)) - [murrant](https://github.com/murrant)
* Lnms bash completion ([#9747](https://github.com/jadounrahul/kartsnms/pull/9747)) - [murrant](https://github.com/murrant)
* Hook many commands into the lnms script ([#9699](https://github.com/jadounrahul/kartsnms/pull/9699)) - [murrant](https://github.com/murrant)
* Add lnms command ([#9619](https://github.com/jadounrahul/kartsnms/pull/9619)) - [murrant](https://github.com/murrant)
* Allow grouping of sensors ([#9606](https://github.com/jadounrahul/kartsnms/pull/9606)) - [murrant](https://github.com/murrant)
* Validate database constraints ([#9670](https://github.com/jadounrahul/kartsnms/pull/9670)) - [murrant](https://github.com/murrant)

#### Bug
* Fix Exception in GraylogAPI.php ([#9617](https://github.com/jadounrahul/kartsnms/pull/9617)) - [zoc](https://github.com/zoc)
* Fix devices page search & OS loading ([#9752](https://github.com/jadounrahul/kartsnms/pull/9752)) - [murrant](https://github.com/murrant)
* Revert "Mattermost Alert Transport" ([#9743](https://github.com/jadounrahul/kartsnms/pull/9743)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Validate default config seeder ([#9723](https://github.com/jadounrahul/kartsnms/pull/9723)) - [murrant](https://github.com/murrant)
* Fix missing config setting in DB seed alert.transports.mail ([#9721](https://github.com/jadounrahul/kartsnms/pull/9721)) - [murrant](https://github.com/murrant)
* Fix sql schema 278 ([#9715](https://github.com/jadounrahul/kartsnms/pull/9715)) - [murrant](https://github.com/murrant)
* Alert Rules: fix for critical and warning rule ([#9688](https://github.com/jadounrahul/kartsnms/pull/9688)) - [kkrumm1](https://github.com/kkrumm1)
* Fix if discover overwritting fields ([#9643](https://github.com/jadounrahul/kartsnms/pull/9643)) - [evheros](https://github.com/evheros)
* Fix validate error ([#9700](https://github.com/jadounrahul/kartsnms/pull/9700)) - [murrant](https://github.com/murrant)
* Update Mimosa.php ([#9695](https://github.com/jadounrahul/kartsnms/pull/9695)) - [kiwibrew](https://github.com/kiwibrew)
* Rename kartsnms script to lnms ([#9696](https://github.com/jadounrahul/kartsnms/pull/9696)) - [murrant](https://github.com/murrant)
* Seeds can run on existing ([#9689](https://github.com/jadounrahul/kartsnms/pull/9689)) - [murrant](https://github.com/murrant)
* Run both legacy schema and migrations in the same run if needed ([#9686](https://github.com/jadounrahul/kartsnms/pull/9686)) - [murrant](https://github.com/murrant)
* Fix dbSchema 1000 skipping schema files ([#9685](https://github.com/jadounrahul/kartsnms/pull/9685)) - [murrant](https://github.com/murrant)
* Removed NO_AUTO_CREATE_USER from mysql strict to support MySQL 8 ([#9668](https://github.com/jadounrahul/kartsnms/pull/9668)) - [laf](https://github.com/laf)
* Increase snmp execution time limit to 20 minutes ([#9639](https://github.com/jadounrahul/kartsnms/pull/9639)) - [murrant](https://github.com/murrant)
* Add group to sensor 1st discovery + template syntax {{ $xxx }} ([#9667](https://github.com/jadounrahul/kartsnms/pull/9667)) - [PipoCanaja](https://github.com/PipoCanaja)
* Order by support for availability map widget ([#9663](https://github.com/jadounrahul/kartsnms/pull/9663)) - [murrant](https://github.com/murrant)
* Remove broken routeros signal sensor ([#9650](https://github.com/jadounrahul/kartsnms/pull/9650)) - [murrant](https://github.com/murrant)
* Fix sentry3 voltage sensors ([#9649](https://github.com/jadounrahul/kartsnms/pull/9649)) - [murrant](https://github.com/murrant)
* Fix wireless sensor edit messages and collection alert rule ([#9624](https://github.com/jadounrahul/kartsnms/pull/9624)) - [murrant](https://github.com/murrant)
* Fix poller.php with missing -h ([#9621](https://github.com/jadounrahul/kartsnms/pull/9621)) - [murrant](https://github.com/murrant)
* Fix Infoblox NIOS graphs ([#9620](https://github.com/jadounrahul/kartsnms/pull/9620)) - [murrant](https://github.com/murrant)
* Fix .gitingore "changed" files with github-remove script ([#9616](https://github.com/jadounrahul/kartsnms/pull/9616)) - [murrant](https://github.com/murrant)
* Fix orphaned dashboards ([#9590](https://github.com/jadounrahul/kartsnms/pull/9590)) - [murrant](https://github.com/murrant)

#### Webui
* Pressing enter on global search goes to the first result ([#9587](https://github.com/jadounrahul/kartsnms/pull/9587)) - [murrant](https://github.com/murrant)
* Fix devices page search & OS loading ([#9752](https://github.com/jadounrahul/kartsnms/pull/9752)) - [murrant](https://github.com/murrant)
* Rewrite devices page backend (and a little frontend) ([#9726](https://github.com/jadounrahul/kartsnms/pull/9726)) - [murrant](https://github.com/murrant)
* Handle db update errors better in the installer ([#9701](https://github.com/jadounrahul/kartsnms/pull/9701)) - [murrant](https://github.com/murrant)
* Improve display for 802.1X NAC ([#9706](https://github.com/jadounrahul/kartsnms/pull/9706)) - [PipoCanaja](https://github.com/PipoCanaja)
* Refactor FDB Tables to Laravel ([#9669](https://github.com/jadounrahul/kartsnms/pull/9669)) - [murrant](https://github.com/murrant)
* Better IP exists feedback when adding a device ([#9697](https://github.com/jadounrahul/kartsnms/pull/9697)) - [murrant](https://github.com/murrant)
* Order by support for availability map widget ([#9663](https://github.com/jadounrahul/kartsnms/pull/9663)) - [murrant](https://github.com/murrant)
* Sort device select by hostname ([#9607](https://github.com/jadounrahul/kartsnms/pull/9607)) - [murrant](https://github.com/murrant)
* Alert schedule refactor ([#9514](https://github.com/jadounrahul/kartsnms/pull/9514)) - [murrant](https://github.com/murrant)
* Removed Legacy Transport UI https://t.kartsn.ms/deprecation-alerting ([#9552](https://github.com/jadounrahul/kartsnms/pull/9552)) - [laf](https://github.com/laf)

#### Device
* Adding temp/humidity sensors for raritan px2 ([#9719](https://github.com/jadounrahul/kartsnms/pull/9719)) - [sjtarik](https://github.com/sjtarik)
* FreeBSD mempools Fix ([#9659](https://github.com/jadounrahul/kartsnms/pull/9659)) - [vitalisator](https://github.com/vitalisator)
* Adding Sonicwall SMA 400 support ([#9555](https://github.com/jadounrahul/kartsnms/pull/9555)) - [marvink87](https://github.com/marvink87)
* Support for Alcatel OmniPCX ([#9375](https://github.com/jadounrahul/kartsnms/pull/9375)) - [PipoCanaja](https://github.com/PipoCanaja)
* Improve index check for compatibility with different versions of the DDOS ([#9698](https://github.com/jadounrahul/kartsnms/pull/9698)) - [acl](https://github.com/acl)
* Eltek Valere more sensors ([#9713](https://github.com/jadounrahul/kartsnms/pull/9713)) - [murrant](https://github.com/murrant)
* New OS: Schleifenbauer, entity-physical improvements, various html page fixes ([#9471](https://github.com/jadounrahul/kartsnms/pull/9471)) - [martijn-schmidt](https://github.com/martijn-schmidt)
* Huawei iBMC absent state grey ([#9691](https://github.com/jadounrahul/kartsnms/pull/9691)) - [murrant](https://github.com/murrant)
* Nokia vrf bgp ([#9622](https://github.com/jadounrahul/kartsnms/pull/9622)) - [vitalisator](https://github.com/vitalisator)
* Implement NAC data polling ([#9592](https://github.com/jadounrahul/kartsnms/pull/9592)) - [PipoCanaja](https://github.com/PipoCanaja)
* Cable Modem Graphs for TopVision OS ([#9679](https://github.com/jadounrahul/kartsnms/pull/9679)) - [djamp42](https://github.com/djamp42)
* Merge ethernetprobe2 into akcp and improve akcp ([#9465](https://github.com/jadounrahul/kartsnms/pull/9465)) - [murrant](https://github.com/murrant)
* Sorting States using groups ([#9666](https://github.com/jadounrahul/kartsnms/pull/9666)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added ignore mount point effects macOS ([#9652](https://github.com/jadounrahul/kartsnms/pull/9652)) - [kkrumm1](https://github.com/kkrumm1)
* EATON-MGEUPS: Added sensors for temperature and humidity from … ([#9647](https://github.com/jadounrahul/kartsnms/pull/9647)) - [Kal42](https://github.com/Kal42)
* Remove broken routeros signal sensor ([#9650](https://github.com/jadounrahul/kartsnms/pull/9650)) - [murrant](https://github.com/murrant)
* Fix sentry3 voltage sensors ([#9649](https://github.com/jadounrahul/kartsnms/pull/9649)) - [murrant](https://github.com/murrant)
* Fix some issues with sensor limits ([#9638](https://github.com/jadounrahul/kartsnms/pull/9638)) - [murrant](https://github.com/murrant)
* Added support for Vigintos Modulator & Ampiflier ([#9488](https://github.com/jadounrahul/kartsnms/pull/9488)) - [jozefrebjak](https://github.com/jozefrebjak)
* Device Support for Pegasus ([#9641](https://github.com/jadounrahul/kartsnms/pull/9641)) - [vitalisator](https://github.com/vitalisator)
* TopVision CMTS ([#9627](https://github.com/jadounrahul/kartsnms/pull/9627)) - [djamp42](https://github.com/djamp42)
* Fix Infoblox NIOS graphs ([#9620](https://github.com/jadounrahul/kartsnms/pull/9620)) - [murrant](https://github.com/murrant)
* ZyXEL Telemetry - XGS4600-32F ([#9599](https://github.com/jadounrahul/kartsnms/pull/9599)) - [cppmonkey](https://github.com/cppmonkey)

#### Security
* Rewrite devices page backend (and a little frontend) ([#9726](https://github.com/jadounrahul/kartsnms/pull/9726)) - [murrant](https://github.com/murrant)
* Rewrite netcmd and ripe whois tools ([#9724](https://github.com/jadounrahul/kartsnms/pull/9724)) - [murrant](https://github.com/murrant)
* Update dependencies ([#9657](https://github.com/jadounrahul/kartsnms/pull/9657)) - [murrant](https://github.com/murrant)
* Refactor FDB Tables to Laravel ([#9669](https://github.com/jadounrahul/kartsnms/pull/9669)) - [murrant](https://github.com/murrant)

#### Documentation
* Update docs on mkdocs ([#9631](https://github.com/jadounrahul/kartsnms/pull/9631)) - [emestee](https://github.com/emestee)
* New OS: Suggest -d in discovery.php to clear cache ([#9602](https://github.com/jadounrahul/kartsnms/pull/9602)) - [murrant](https://github.com/murrant)
* FAQ KartsNMS and MIBs ([#9664](https://github.com/jadounrahul/kartsnms/pull/9664)) - [murrant](https://github.com/murrant)
* Update Fast-Ping-Check.md ([#9705](https://github.com/jadounrahul/kartsnms/pull/9705)) - [sanegaming](https://github.com/sanegaming)
* Update poller_modules documentation for NAC ([#9704](https://github.com/jadounrahul/kartsnms/pull/9704)) - [PipoCanaja](https://github.com/PipoCanaja)
* Docs:Update SNMP-Trap-Handler.md ([#9654](https://github.com/jadounrahul/kartsnms/pull/9654)) - [JoshWeepie](https://github.com/JoshWeepie)
* Oxidized JunOS syslog hook documentation fix ([#9676](https://github.com/jadounrahul/kartsnms/pull/9676)) - [nova-2nd](https://github.com/nova-2nd)
* Reference config options for new beta poller service ([#9644](https://github.com/jadounrahul/kartsnms/pull/9644)) - [Swashy](https://github.com/Swashy)
