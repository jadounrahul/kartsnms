...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/alerts/1
```
...
```curl
curl -X PUT -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/alerts/1
```
...
```curl
curl -X PUT -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/alerts/unmute/1
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/alerts?state=1
```

```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/alerts?severity=critical
```

```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/alerts?order=timestamp%20ASC
```

```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/alerts?alert_rule=49
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/rules/1
```
...
```curl
curl -X DELETE -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/rules/1
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/rules
```
