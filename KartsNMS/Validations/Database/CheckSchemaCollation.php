...
namespace KartsNMS\Validations\Database;

use KartsNMS\DB\Eloquent;
use KartsNMS\Interfaces\Validation;
use KartsNMS\Interfaces\ValidationFixer;
    ...
    public function validate(): ValidationResult
    {
        ...
        if (empty($collation) !== true) {
            return ValidationResult::fail(
                ...
                'Check https://community.itkarts.com/t/new-default-database-charset-collation/14956 for info on how to fix.'
            )->setFixer(__CLASS__);
        }
        ...
        if (empty($collation_tables) !== true) {
            return ValidationResult::fail('MySQL tables collation is wrong: ')
                ->setFix('Check https://community.itkarts.com/t/new-default-database-charset-collation/14956 for info on how to fix.')
                ->setFixer(__CLASS__)
