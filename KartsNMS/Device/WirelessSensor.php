...
class WirelessSensor extends Sensor
{
    ...
    {
        return StringHelpers::toClass($type, 'KartsNMS\\Interfaces\\Discovery\\Sensors\\Wireless') . 'Discovery';
    }
    ...
    {
        return StringHelpers::toClass($type, 'KartsNMS\\Interfaces\\Polling\\Sensors\\Wireless') . 'Polling';
    }
