#! /usr/bin/env python3
"""
This is a Bootstrap script for wrapper.py, in order to retain compatibility with earlier KartsNMS setups
"""
...
import KartsNMS
import KartsNMS.wrapper as wrapper
...
config = KartsNMS.get_config_data(os.path.dirname(os.path.realpath(__file__)))
if not config:
...
logger = KartsNMS.logger_get_logger(log_file, debug=args.debug)
