    ...
    WirelessSnrDiscovery
{
    ...
    /**
     * Retrieve (and explode to array) list of network interfaces, and desired display name in KartsNMS.
     ...
     * type - string, matching to KartsNMS documentation => https://docs.kartsnms.org/Developing/os/Wireless-Sensors/
    ...
    {
        // Initialize needed variables, and get interfaces (actual network name, and KartsNMS name)
        $sensors = [];
