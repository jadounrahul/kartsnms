...
The main problem is that KartsNMS will by default discover this card as pCOweb
and not as your real manufacturer like it should. A solution was found
to bypass this issue, but it's KartsNMS independent and you need to
...
## Configuring the pCOweb card SNMP for KartsNMS
...
will allow us to create a specific support for this device. Kartsnms uses this value to detect which HVAC device is connected to the pCOWeb card.
...
1. Adding value to identify this device in KartsNMS : **1**
...
KartsNMS is ready for the devices listed in this table. You only need
...
start the KartsNMS [new OS implementation](Developing/Support-New-OS/)
