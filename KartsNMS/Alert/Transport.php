...
use KartsNMS\Interfaces\Alert\Transport as TransportInterface;
...
abstract class Transport implements TransportInterface
{
    ...
    {
        $list = [];
        foreach (glob(base_path('KartsNMS/Alert/Transport/*.php')) as $file) {
    ...
    {
        return 'KartsNMS\\Alert\\Transport\\' . ucfirst($type);
    }
