...
namespace KartsNMS\Data\Store;

use App\Polling\Measure\Measurement;
use Illuminate\Support\Str;
use KartsNMS\Config;
use KartsNMS\Exceptions\FileExistsException;
...
class Rrd extends BaseDatastore
{
    ...
    /**
     * rename an rrdfile, can only be done on the KartsNMS server hosting the rrd files
     *
