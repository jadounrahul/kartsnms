...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/port_groups
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/port_groups/Billable
```
...
curl -H 'X-Auth-Token: YOURAPITOKENHERE' \
  ...
  https://kartsnms.org/api/v0/port_groups
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' -X POST -d '{"port_ids": ["4","34","25,"983"]}' https://kartsnms.org/api/v0/port_groups/3/assign
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' -X POST -d '{"port_ids": ["4","34","25,"983"]}' https://kartsnms.org/api/v0/port_groups/3/remove
```
