...
class ObjectCache implements ArrayAccess
{
    ...
    public function __construct($obj)
    {
        ...
        if (isset($GLOBALS['_ObjCache'][$obj])) {
            ...
            if (file_exists(\KartsNMS\Config::get('install_dir') . '/includes/caches/' . $obj . '.inc.php')) {
                $data = [];
                include \KartsNMS\Config::get('install_dir') . '/includes/caches/' . $obj . '.inc.php';
                $this->data = $data;
