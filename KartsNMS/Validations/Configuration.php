...
class Configuration extends BaseValidation
{
    ...
    public function validate(Validator $validator): void
    {
        ...
        if (Config::get('alerts.email.enable') == true) {
            $validator->warn('You have the old alerting system enabled - this is to be deprecated on the 1st of June 2015: https://groups.google.com/forum/#!topic/kartsnms-project/1llxos4m0p4');
        }
        ...
        if (Config::has('validation.encryption.test')) {
            try {
                if (\Crypt::decryptString(Config::get('validation.encryption.test')) !== 'kartsnms') {
            ...
            Config::persist('validation.encryption.test', \Crypt::encryptString('kartsnms'));
        }
    }

    /**
     * @param  \KartsNMS\Validator  $validator
     */
