...
<table id="port-arp" class="table table-condensed table-hover table-striped">
    <thead>
        <tr>
            ...
            <th data-column-id="mac_oui" data-sortable="false" data-width="" data-visible="<?php echo \KartsNMS\Config::get('mac_oui.enabled') ? 'true' : 'false' ?>" data-formatter="tooltip">Vendor</th>
