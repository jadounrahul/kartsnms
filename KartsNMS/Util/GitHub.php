...
class GitHub
{
    ...
    protected $markdown;
    protected $github = 'https://api.github.com/repos/kartsnms/kartsnms';
    ...
    public function getPullRequests($date, $after = null)
    {
        ...
        $query = <<<GRAPHQL
{
  search(query: "repo:kartsnms/kartsnms is:pr is:merged merged:>=$date", type: ISSUE, first: 100$after) {
    edges {
      node {
        ... on PullRequest {
          number
...
GRAPHQL;
    ...
    {
        $version_file = 'KartsNMS/Util/Version.php';
