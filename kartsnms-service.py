...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="KartsNMS Service - manages polling and other periodic processes"
    )
    parser.add_argument(
        "-g",
        "--group",
    ...
    info("Configuring KartsNMS service")
    try:
        service = KartsNMS.Service()
    ...
    info(
        "Entering main KartsNMS service loop on {}/{}...".format(
