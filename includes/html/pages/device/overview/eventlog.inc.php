...
$eventlog = dbFetchRows("SELECT *,DATE_FORMAT(datetime, '" . \KartsNMS\Config::get('dateformat.mysql.compact') . "') as humandate FROM `eventlog` WHERE `device_id` = ? ORDER BY `datetime` DESC LIMIT 0,10", [$device['device_id']]);
