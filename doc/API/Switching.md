...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/resources/vlans
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/devices/localhost/vlans
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/resources/links
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/devices/localhost/links
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/resources/links/10
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/resources/fdb
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/resources/fdb/1aaa2bbb3ccc
```
...
Example:
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://kartsnms.org/api/v0/resources/fdb/1aaa2bbb3ccc/detail
```
