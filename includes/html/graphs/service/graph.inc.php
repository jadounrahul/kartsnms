<?php
/*
 * KartsNMS module to display graphing for Nagios Service
 *
...
$check_script = \KartsNMS\Config::get('install_dir') . '/includes/services/check_' . strtolower($services[$vars['service']]['service_type']) . '.inc.php';
...
if ($services[$vars['service']]['service_ds'] != '') {
    ...
    if (Rrd::checkRrdExists($rrd_filename)) {
        if (isset($check_graph)) {
            ...
            $color_avg = \KartsNMS\Config::get("graph_colours.$tint.2");
            $color_max = \KartsNMS\Config::get("graph_colours.$tint.0");
