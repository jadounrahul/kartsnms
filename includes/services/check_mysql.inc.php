...
$check_cmd = \KartsNMS\Config::get('nagios_plugins') . '/check_mysql -H ' . $service['hostname'] . ' ' . $dbname . ' ' . $service['service_param'];
...
$check_graph = [];
$mixed_colours = \KartsNMS\Config::get('graph_colours.mixed');
