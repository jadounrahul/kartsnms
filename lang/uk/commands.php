...
return [
    ...
    'dev:check' => [
        'description' => 'Перевірки коду KartsNMS. Запуск без опцій запускає всі перевірки',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'Ім\'я файлу snmprec який необхідно оновити або додати до KartsNMS. Якщо файл не вказано, пристрій не буде додано або оновлено.',
        ],
        'options' => [
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'Для додаткової інформації див. https://docs.kartsnms.org/Extensions/Smokeping/"',
