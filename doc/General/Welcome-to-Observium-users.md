KartsNMS is a fork of Observium.  The reason for the fork has nothing to do
...
KartsNMS was forked from [the last GPL-licensed version of Observium][3].
...
KartsNMS. This also takes care of moving from one CPU architecture to
another. Give it a try :)

How KartsNMS will be different from Observium:
...
Reasons why you might want to use Observium instead of KartsNMS:
...
Reasons why you might want to use KartsNMS instead of Observium:
...
- You want to make use of the additional features KartsNMS can offer.

[1]: http://postman.memetic.org/pipermail/observium/2013-October/003915.html
"Observium edition split announcement"
[2]: https://github.com/jadounrahul/kartsnms/blob/master/README.md
"KartsNMS README"
[3]: http://fisheye.observium.org/rdiff/Observium?csid=3251&u&N
"Link to Observium license change"
[5]: https://github.com/jadounrahul/kartsnms/blob/master/LICENSE.txt
"KartsNMS copy of GPL v3"
...
[9]: https://community.itkarts.com
"KartsNMS issue database at GitHub"
[10]: ../Installation/Migrating-from-Observium.md
"Migrating from Observium to KartsNMS"
