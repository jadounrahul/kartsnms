...
* Fix typo cause empty data for NFS Server ([#12223](https://github.com/jadounrahul/kartsnms/pull/12223)) - [clarkchentw](https://github.com/clarkchentw)
...
* Adding serial number discovery to aruba os poller ([#12053](https://github.com/jadounrahul/kartsnms/pull/12053)) - [sjtarik](https://github.com/sjtarik)
...
* Arista EOS: Added groups and better sensor names ([#11990](https://github.com/jadounrahul/kartsnms/pull/11990)) - [TheGreatDoc](https://github.com/TheGreatDoc)
...
* OS detection for Dell PowerVault MD arrays ([#11509](https://github.com/jadounrahul/kartsnms/pull/11509)) - [TheMysteriousX](https://github.com/TheMysteriousX)
...
* VRP FDB table correctly parsed on some CE switches ([#11766](https://github.com/jadounrahul/kartsnms/pull/11766)) - [PipoCanaja](https://github.com/PipoCanaja)
...
* Don't call clean() on the inputs to the SNMP settings form ([#11709](https://github.com/jadounrahul/kartsnms/pull/11709)) - [cjwbath](https://github.com/cjwbath)
...
* SIAE Radio: add additional sensors and data ([#11498](https://github.com/jadounrahul/kartsnms/pull/11498)) - [murrant](https://github.com/murrant)
...
* MPLS updates and bugfixing ([#11468](https://github.com/jadounrahul/kartsnms/pull/11468)) - [vitalisator](https://github.com/vitalisator)
* Airos 8.x.x no long supports AirMaxQuality ([#11400](https://github.com/jadounrahul/kartsnms/pull/11400)) - [facuxt](https://github.com/facuxt)
* Added discovery and graphing for JunOS (SRX) RPM probes ([#11187](https://github.com/jadounrahul/kartsnms/pull/11187)) - [PelNet](https://github.com/PelNet)
* Added FortiMail support ([#10895](https://github.com/jadounrahul/kartsnms/pull/10895)) - [footstep86](https://github.com/footstep86)

#### Webui
* Fixing API Creation Error Message ([#11745](https://github.com/jadounrahul/kartsnms/pull/11745)) - [SourceDoctor](https://github.com/SourceDoctor)
* Show full description text on MySQL RRDs ([#11738](https://github.com/jadounrahul/kartsnms/pull/11738)) - [SourceDoctor](https://github.com/SourceDoctor)
* Maximum Execution Time Exceeded show error ([#11720](https://github.com/jadounrahul/kartsnms/pull/11720)) - [murrant](https://github.com/murrant)
* Enumerate Alert Level ([#11652](https://github.com/jadounrahul/kartsnms/pull/11652)) - [SourceDoctor](https://github.com/SourceDoctor)
* Show Laravel version in about ([#11641](https://github.com/jadounrahul/kartsnms/pull/11641)) - [murrant](https://github.com/murrant)
* Fix various issues with loading os definitions ([#11640](https://github.com/jadounrahul/kartsnms/pull/11640)) - [murrant](https://github.com/murrant)
* Application State Icons ([#11630](https://github.com/jadounrahul/kartsnms/pull/11630)) - [SourceDoctor](https://github.com/SourceDoctor)
* Handle exception about unserializable route cache ([#11625](https://github.com/jadounrahul/kartsnms/pull/11625)) - [murrant](https://github.com/murrant)
* Fixed realtime graph http get spam ([#11616](https://github.com/jadounrahul/kartsnms/pull/11616)) - [Butterscup](https://github.com/Butterscup)
* Disable auto-refresh for notifications and alert history ([#11589](https://github.com/jadounrahul/kartsnms/pull/11589)) - [louis-oui](https://github.com/louis-oui)
* Sort Health table alphabetic ([#11586](https://github.com/jadounrahul/kartsnms/pull/11586)) - [SourceDoctor](https://github.com/SourceDoctor)
* Only Show in TopInterfaces Devices which are up ([#11578](https://github.com/jadounrahul/kartsnms/pull/11578)) - [SourceDoctor](https://github.com/SourceDoctor)
* Natural Sort Applications by Display Name ([#11577](https://github.com/jadounrahul/kartsnms/pull/11577)) - [SourceDoctor](https://github.com/SourceDoctor)
* Application DisplayName in Overview Hover ([#11576](https://github.com/jadounrahul/kartsnms/pull/11576)) - [SourceDoctor](https://github.com/SourceDoctor)
* Add acknowledgment notes to eventlog ([#11575](https://github.com/jadounrahul/kartsnms/pull/11575)) - [vitalisator](https://github.com/vitalisator)
* Fix vmhost device page link ([#11553](https://github.com/jadounrahul/kartsnms/pull/11553)) - [murrant](https://github.com/murrant)
* Correct OS Overlib in Inventory ([#11551](https://github.com/jadounrahul/kartsnms/pull/11551)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix poller deletion ([#11549](https://github.com/jadounrahul/kartsnms/pull/11549)) - [murrant](https://github.com/murrant)
* Fix smokeping wo integration ([#11548](https://github.com/jadounrahul/kartsnms/pull/11548)) - [murrant](https://github.com/murrant)
* Show Hardware Details on Network Adapters in Device - Inventory ([#11545](https://github.com/jadounrahul/kartsnms/pull/11545)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix display of device modules ([#11543](https://github.com/jadounrahul/kartsnms/pull/11543)) - [ospfbgp](https://github.com/ospfbgp)
* Addhost (web) snmp v3 not used first ([#11536](https://github.com/jadounrahul/kartsnms/pull/11536)) - [nimrof](https://github.com/nimrof)
* Fix apps overview link ([#11535](https://github.com/jadounrahul/kartsnms/pull/11535)) - [murrant](https://github.com/murrant)
* Sort Top Devices widget descending by default ([#11534](https://github.com/jadounrahul/kartsnms/pull/11534)) - [murrant](https://github.com/murrant)
* Update device health settings Table UI ([#11529](https://github.com/jadounrahul/kartsnms/pull/11529)) - [arjitc](https://github.com/arjitc)
* Fix errors for some devices loading components ([#11527](https://github.com/jadounrahul/kartsnms/pull/11527)) - [murrant](https://github.com/murrant)
* Fix new bill search input ([#11524](https://github.com/jadounrahul/kartsnms/pull/11524)) - [murrant](https://github.com/murrant)
* Equalize BootstrapSwitch Style on Device Edit to KartsNMS Standard ([#11513](https://github.com/jadounrahul/kartsnms/pull/11513)) - [arjitc](https://github.com/arjitc)
* Limit port, seconds, retries, max repeats and max OIDs to numeric type ([#11512](https://github.com/jadounrahul/kartsnms/pull/11512)) - [arjitc](https://github.com/arjitc)
* Put all the stats into the optionbar ([#11501](https://github.com/jadounrahul/kartsnms/pull/11501)) - [arjitc](https://github.com/arjitc)
* Login form footer center align ([#11499](https://github.com/jadounrahul/kartsnms/pull/11499)) - [jozefrebjak](https://github.com/jozefrebjak)
* WebUI - Improved "dark" theme ([#11417](https://github.com/jadounrahul/kartsnms/pull/11417)) - [facuxt](https://github.com/facuxt)

#### Snmp Traps
* OSPF SNMP Trap Handlers ([#11647](https://github.com/jadounrahul/kartsnms/pull/11647)) - [h-barnhart](https://github.com/h-barnhart)
* Added warmStart trap handler ([#11583](https://github.com/jadounrahul/kartsnms/pull/11583)) - [jozefrebjak](https://github.com/jozefrebjak)

#### Applications
* Add support for windows kartsnms(check_mk) agent ([#11691](https://github.com/jadounrahul/kartsnms/pull/11691)) - [gardar](https://github.com/gardar)
* Application - Redis ([#11612](https://github.com/jadounrahul/kartsnms/pull/11612)) - [SourceDoctor](https://github.com/SourceDoctor)
* Adjust RRDCached application event graph ([#11528](https://github.com/jadounrahul/kartsnms/pull/11528)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix RRDCached Application Socket Address in Poller ([#11525](https://github.com/jadounrahul/kartsnms/pull/11525)) - [SourceDoctor](https://github.com/SourceDoctor)
* String Nicement for RRDCached - also alphabetic sorting of array ([#11517](https://github.com/jadounrahul/kartsnms/pull/11517)) - [SourceDoctor](https://github.com/SourceDoctor)

#### Api
* Enabling general search for ports, devices, and more ([#11571](https://github.com/jadounrahul/kartsnms/pull/11571)) - [hachpai](https://github.com/hachpai)

#### Alerting
* Fix another mysql error in isMaintenance() ([#11746](https://github.com/jadounrahul/kartsnms/pull/11746)) - [arrmo](https://github.com/arrmo)
* Address Incorrect DATE value in isUnderMaintenance ([#11736](https://github.com/jadounrahul/kartsnms/pull/11736)) - [arrmo](https://github.com/arrmo)
* Do not delay alert recovery notifications ([#11555](https://github.com/jadounrahul/kartsnms/pull/11555)) - [spencerryan](https://github.com/spencerryan)
* Send Device group membership to Pagerduty ([#11522](https://github.com/jadounrahul/kartsnms/pull/11522)) - [spencerryan](https://github.com/spencerryan)
* Allow manual configuration of Pagerduty Integration Key ([#11519](https://github.com/jadounrahul/kartsnms/pull/11519)) - [spencerryan](https://github.com/spencerryan)
* Copy and modify the syslog transport for sending alerts to Splunk in an easy to parse format ([#11176](https://github.com/jadounrahul/kartsnms/pull/11176)) - [VirTechSystems](https://github.com/VirTechSystems)

#### Discovery
* Fix sensor type/class confusion ([#11608](https://github.com/jadounrahul/kartsnms/pull/11608)) - [PipoCanaja](https://github.com/PipoCanaja)
* Improvement for matching LLDP neighbors with known hosts. ([#11445](https://github.com/jadounrahul/kartsnms/pull/11445)) - [dagbdagb](https://github.com/dagbdagb)
* Migrate Python scripts to Python 3 ([#10759](https://github.com/jadounrahul/kartsnms/pull/10759)) - [deajan](https://github.com/deajan)

#### Polling
* Fix wireless sensor polling unit display ([#11748](https://github.com/jadounrahul/kartsnms/pull/11748)) - [murrant](https://github.com/murrant)
* Fix poller enabling graphs for display ([#11743](https://github.com/jadounrahul/kartsnms/pull/11743)) - [murrant](https://github.com/murrant)
* Fix dynamic group membership rule for devices.status equal 0 ([#11699](https://github.com/jadounrahul/kartsnms/pull/11699)) - [ajsiersema](https://github.com/ajsiersema)
* Fix - Seperate default poller id and distributed poller groups ([#11584](https://github.com/jadounrahul/kartsnms/pull/11584)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix double escaping ([#11503](https://github.com/jadounrahul/kartsnms/pull/11503)) - [gcotone](https://github.com/gcotone)

#### Rancid
* Add Edgemax support to rancid script ([#11687](https://github.com/jadounrahul/kartsnms/pull/11687)) - [dupondje](https://github.com/dupondje)
* Support for allied telesis and cisco wlc ([#11617](https://github.com/jadounrahul/kartsnms/pull/11617)) - [cliffalbert](https://github.com/cliffalbert)

#### Bug
* Fix MySQL App sorts display ([#11740](https://github.com/jadounrahul/kartsnms/pull/11740)) - [SourceDoctor](https://github.com/SourceDoctor)
* Remove int width from db schema validation (MySQL 8) ([#11725](https://github.com/jadounrahul/kartsnms/pull/11725)) - [arrmo](https://github.com/arrmo)
* Fix CSRF Token in Latency tab ([#11703](https://github.com/jadounrahul/kartsnms/pull/11703)) - [f0o](https://github.com/f0o)
* Fix some python3 wrapper connection issues ([#11693](https://github.com/jadounrahul/kartsnms/pull/11693)) - [murrant](https://github.com/murrant)
* Fix the PANOS HA state check alert rule from collection ([#11657](https://github.com/jadounrahul/kartsnms/pull/11657)) - [cjwbath](https://github.com/cjwbath)
* Fix inconsistent escapes (slashes in sysLocation) ([#11637](https://github.com/jadounrahul/kartsnms/pull/11637)) - [murrant](https://github.com/murrant)
* Fix "improper label name" in Prometheus datastore ([#11602](https://github.com/jadounrahul/kartsnms/pull/11602)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Filter on sensor class as expected and documented ([#11592](https://github.com/jadounrahul/kartsnms/pull/11592)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix python always install as user ([#11562](https://github.com/jadounrahul/kartsnms/pull/11562)) - [murrant](https://github.com/murrant)
* Fix default uptime warning to 86400 seconds ([#11507](https://github.com/jadounrahul/kartsnms/pull/11507)) - [SourceDoctor](https://github.com/SourceDoctor)

#### Refactor
* Clean mempools code to avoid unnecessary snmpget ([#11678](https://github.com/jadounrahul/kartsnms/pull/11678)) - [PipoCanaja](https://github.com/PipoCanaja)
* Enumerate AlertState ([#11665](https://github.com/jadounrahul/kartsnms/pull/11665)) - [SourceDoctor](https://github.com/SourceDoctor)
* Python wrapper sql cleanup ([#11628](https://github.com/jadounrahul/kartsnms/pull/11628)) - [murrant](https://github.com/murrant)
* Python3 only for snmp-scan.py ([#11623](https://github.com/jadounrahul/kartsnms/pull/11623)) - [murrant](https://github.com/murrant)
* Laravel 6.x ([#11397](https://github.com/jadounrahul/kartsnms/pull/11397)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Documentation
* Update rrdtool setting explanation ([#11724](https://github.com/jadounrahul/kartsnms/pull/11724)) - [hanserasmus](https://github.com/hanserasmus)
* Update distributed poller docs intro ([#11721](https://github.com/jadounrahul/kartsnms/pull/11721)) - [murrant](https://github.com/murrant)
* Hardware examples SourceDoctor ([#11680](https://github.com/jadounrahul/kartsnms/pull/11680)) - [SourceDoctor](https://github.com/SourceDoctor)
* Applications Corrected wrong path in documentation ([#11675](https://github.com/jadounrahul/kartsnms/pull/11675)) - [ProTofik](https://github.com/ProTofik)
* Document update for distributed poller ([#11655](https://github.com/jadounrahul/kartsnms/pull/11655)) - [craig-nokia](https://github.com/craig-nokia)
* Fix Fast-Ping-Check.md to include information about RRDCached ([#11645](https://github.com/jadounrahul/kartsnms/pull/11645)) - [jonasblomq](https://github.com/jonasblomq)
* Update Example-Hardware-Setup.md ([#11611](https://github.com/jadounrahul/kartsnms/pull/11611)) - [lazyb0nes](https://github.com/lazyb0nes)
* Removed reference to deprecated poller-service.py ([#11598](https://github.com/jadounrahul/kartsnms/pull/11598)) - [hanserasmus](https://github.com/hanserasmus)
* Added example for the alerta transport ([#11596](https://github.com/jadounrahul/kartsnms/pull/11596)) - [olivluca](https://github.com/olivluca)
* Add missing python3 modules from repo, remove pip ([#11594](https://github.com/jadounrahul/kartsnms/pull/11594)) - [gardar](https://github.com/gardar)
* Correct sensor ignore documentation ([#11591](https://github.com/jadounrahul/kartsnms/pull/11591)) - [PipoCanaja](https://github.com/PipoCanaja)
* Typo Fix ([#11588](https://github.com/jadounrahul/kartsnms/pull/11588)) - [Munzy](https://github.com/Munzy)
* Update Docker installation doc ([#11579](https://github.com/jadounrahul/kartsnms/pull/11579)) - [crazy-max](https://github.com/crazy-max)
* Add python3 and pip3 to installs ([#11566](https://github.com/jadounrahul/kartsnms/pull/11566)) - [hanserasmus](https://github.com/hanserasmus)
* Added python3 for new installs ([#11564](https://github.com/jadounrahul/kartsnms/pull/11564)) - [hanserasmus](https://github.com/hanserasmus)
* Added note about having same APP_KEY value ([#11521](https://github.com/jadounrahul/kartsnms/pull/11521)) - [hanserasmus](https://github.com/hanserasmus)
* Updated Index to add the doc for Debian 10 ([#11515](https://github.com/jadounrahul/kartsnms/pull/11515)) - [stylersnico](https://github.com/stylersnico)
* Update Installation-Ubuntu-1804-Nginx.md ([#11466](https://github.com/jadounrahul/kartsnms/pull/11466)) - [LaZyDK](https://github.com/LaZyDK)

#### Tests
* Testing cleanup ([#11677](https://github.com/jadounrahul/kartsnms/pull/11677)) - [murrant](https://github.com/murrant)
* Rewrite development helper to lnms dev:check ([#11650](https://github.com/jadounrahul/kartsnms/pull/11650)) - [murrant](https://github.com/murrant)
* Fix test behaviour with PHP 7.4 on Fedora 32 ([#11648](https://github.com/jadounrahul/kartsnms/pull/11648)) - [TheMysteriousX](https://github.com/TheMysteriousX)
* Speed up tests by skipping pings ([#11642](https://github.com/jadounrahul/kartsnms/pull/11642)) - [murrant](https://github.com/murrant)
* Update PHPUnit to 8.x ([#11635](https://github.com/jadounrahul/kartsnms/pull/11635)) - [Jellyfrog](https://github.com/Jellyfrog)
* Os_schema is missing a module ([#11511](https://github.com/jadounrahul/kartsnms/pull/11511)) - [TheMysteriousX](https://github.com/TheMysteriousX)

#### Misc
* Check python3 and pip3 versions match ([#11739](https://github.com/jadounrahul/kartsnms/pull/11739)) - [murrant](https://github.com/murrant)
* Check lnms running user ([#11726](https://github.com/jadounrahul/kartsnms/pull/11726)) - [murrant](https://github.com/murrant)
* Make migrations work in SQLite ([#11643](https://github.com/jadounrahul/kartsnms/pull/11643)) - [murrant](https://github.com/murrant)
* Validate PHP version mismatch ([#11621](https://github.com/jadounrahul/kartsnms/pull/11621)) - [murrant](https://github.com/murrant)
* Setuptools is required for python dependency check ([#11600](https://github.com/jadounrahul/kartsnms/pull/11600)) - [SourceDoctor](https://github.com/SourceDoctor)
* Hide python user warning if deps met at system level ([#11590](https://github.com/jadounrahul/kartsnms/pull/11590)) - [murrant](https://github.com/murrant)
* Send python 3 version to stats.kartsnms.org ([#11568](https://github.com/jadounrahul/kartsnms/pull/11568)) - [murrant](https://github.com/murrant)
* Add python validation fix suggestions ([#11563](https://github.com/jadounrahul/kartsnms/pull/11563)) - [murrant](https://github.com/murrant)
* Added ignored devices to be pinged by smokeping ([#11557](https://github.com/jadounrahul/kartsnms/pull/11557)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Python3 Module Dependency Check ([#11544](https://github.com/jadounrahul/kartsnms/pull/11544)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix socket logic in services-wrapper.py ([#11523](https://github.com/jadounrahul/kartsnms/pull/11523)) - [Duffyx](https://github.com/Duffyx)
* Install python requirements during daily ([#11486](https://github.com/jadounrahul/kartsnms/pull/11486)) - [murrant](https://github.com/murrant)
* Run artisan optimize after composer install ([#11465](https://github.com/jadounrahul/kartsnms/pull/11465)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Dependencies
* Bump jquery from 3.4.1 to 3.5.0 ([#11644](https://github.com/jadounrahul/kartsnms/pull/11644)) - [dependabot](https://github.com/apps/dependabot)
...
#### Feature
* Global search MAC Address ([#11434](https://github.com/jadounrahul/kartsnms/pull/11434)) - [SourceDoctor](https://github.com/SourceDoctor)
* Config CLI improvements ([#11430](https://github.com/jadounrahul/kartsnms/pull/11430)) - [murrant](https://github.com/murrant)
* Implement watchdog to kartsnms-service ([#11353](https://github.com/jadounrahul/kartsnms/pull/11353)) - [willhseitz](https://github.com/willhseitz)

#### Device
* Opengear add mempool discovery+polling ([#11491](https://github.com/jadounrahul/kartsnms/pull/11491)) - [gonzocrazy](https://github.com/gonzocrazy)
* Detection, sensors and zpool/dataset usage for FreeNAS, TrueNAS ([#11474](https://github.com/jadounrahul/kartsnms/pull/11474)) - [TheMysteriousX](https://github.com/TheMysteriousX)
* OS detection and sensors for Dell Compellent ([#11467](https://github.com/jadounrahul/kartsnms/pull/11467)) - [TheMysteriousX](https://github.com/TheMysteriousX)
* Add OS detection for Greenbone appliances ([#11464](https://github.com/jadounrahul/kartsnms/pull/11464)) - [TheMysteriousX](https://github.com/TheMysteriousX)
* Raspberry Pi frequency sensors discovery ([#11460](https://github.com/jadounrahul/kartsnms/pull/11460)) - [priiduonu](https://github.com/priiduonu)
* Added Cisco Firepower 1010 ([#11449](https://github.com/jadounrahul/kartsnms/pull/11449)) - [realgreef](https://github.com/realgreef)
* Add OS version to asuswrt-merlin ([#11438](https://github.com/jadounrahul/kartsnms/pull/11438)) - [arrmo](https://github.com/arrmo)
* Added support for Peplink Pepwave & FusionHub ([#11432](https://github.com/jadounrahul/kartsnms/pull/11432)) - [jozefrebjak](https://github.com/jozefrebjak)
* Extend Netvision Socomec UPS cards for RFC1628 ([#11426](https://github.com/jadounrahul/kartsnms/pull/11426)) - [PipoCanaja](https://github.com/PipoCanaja)
* Add support for Advantech switches ([#11415](https://github.com/jadounrahul/kartsnms/pull/11415)) - [monrad](https://github.com/monrad)
* CyberPower SNMP Traps ([#11403](https://github.com/jadounrahul/kartsnms/pull/11403)) - [h-barnhart](https://github.com/h-barnhart)
* Classify as unix for additional sensors ([#11390](https://github.com/jadounrahul/kartsnms/pull/11390)) - [nwautomator](https://github.com/nwautomator)
* IMCO Power - Added skip values for older devices without temperature sensor support. ([#11387](https://github.com/jadounrahul/kartsnms/pull/11387)) - [Martin22](https://github.com/Martin22)
* Ubiquiti Airfiber LTU many more sensors ([#11382](https://github.com/jadounrahul/kartsnms/pull/11382)) - [jepke](https://github.com/jepke)
* Fix routing engine discovery on standalone JunOS devices ([#11381](https://github.com/jadounrahul/kartsnms/pull/11381)) - [TheMysteriousX](https://github.com/TheMysteriousX)
* Add support Ray3 ([#11374](https://github.com/jadounrahul/kartsnms/pull/11374)) - [Martin22](https://github.com/Martin22)
* OPNsense  poller better reporting of Version and Platform ([#11350](https://github.com/jadounrahul/kartsnms/pull/11350)) - [FingerlessGlov3s](https://github.com/FingerlessGlov3s)
* Mikrotik - Updated MIB file and added Wireless Quality ([#11347](https://github.com/jadounrahul/kartsnms/pull/11347)) - [Martin22](https://github.com/Martin22)
* Fix PanOS Sessions count and add Vsys and other sensors ([#11341](https://github.com/jadounrahul/kartsnms/pull/11341)) - [mathieu-oui](https://github.com/mathieu-oui)
* Added hardware detection for FreeBSD ([#11313](https://github.com/jadounrahul/kartsnms/pull/11313)) - [frenchie](https://github.com/frenchie)
* Add support for Ascom IPBS ([#11308](https://github.com/jadounrahul/kartsnms/pull/11308)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added Support for AirConsole Servers ([#11302](https://github.com/jadounrahul/kartsnms/pull/11302)) - [jozefrebjak](https://github.com/jozefrebjak)
* New device IMCO POWER ([#11296](https://github.com/jadounrahul/kartsnms/pull/11296)) - [Martin22](https://github.com/Martin22)
* APC NetBotz 200 - doesn't add not available temperature sensors ([#11259](https://github.com/jadounrahul/kartsnms/pull/11259)) - [dGs-](https://github.com/dGs-)
* IPv6 support for BGP peers in VRP devices ([#11243](https://github.com/jadounrahul/kartsnms/pull/11243)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added support for RIEDO data concentrator ([#11237](https://github.com/jadounrahul/kartsnms/pull/11237)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added support for ICT Modular Power System and ICT Sine Wave Inverter ([#11182](https://github.com/jadounrahul/kartsnms/pull/11182)) - [noaheroufus](https://github.com/noaheroufus)
* Fix for Nokia 7705 SAR ([#11021](https://github.com/jadounrahul/kartsnms/pull/11021)) - [vitalisator](https://github.com/vitalisator)
* Added sensors for outlets on Schleifenbauer devices. ([#10949](https://github.com/jadounrahul/kartsnms/pull/10949)) - [jviersel](https://github.com/jviersel)

#### Webui
* Fix duplicate type="submit" ([#11493](https://github.com/jadounrahul/kartsnms/pull/11493)) - [nimrof](https://github.com/nimrof)
* Fixed a small typo ([#11487](https://github.com/jadounrahul/kartsnms/pull/11487)) - [hanserasmus](https://github.com/hanserasmus)
* Restore click on Dashboard menu entry ([#11478](https://github.com/jadounrahul/kartsnms/pull/11478)) - [murrant](https://github.com/murrant)
* Fix - Show OS specific Mouseover in Alert Widget ([#11457](https://github.com/jadounrahul/kartsnms/pull/11457)) - [SourceDoctor](https://github.com/SourceDoctor)
* Toggle dashboard editor without refresh ([#11455](https://github.com/jadounrahul/kartsnms/pull/11455)) - [murrant](https://github.com/murrant)
* Fix sensor link ([#11454](https://github.com/jadounrahul/kartsnms/pull/11454)) - [murrant](https://github.com/murrant)
* Don't access the database too soon in Device model boot ([#11453](https://github.com/jadounrahul/kartsnms/pull/11453)) - [murrant](https://github.com/murrant)
* Fix devices filter os ([#11443](https://github.com/jadounrahul/kartsnms/pull/11443)) - [murrant](https://github.com/murrant)
* Prevent breaking of interface name into 2 words/parts ([#11420](https://github.com/jadounrahul/kartsnms/pull/11420)) - [arjitc](https://github.com/arjitc)
* Fix dashboard size ([#11405](https://github.com/jadounrahul/kartsnms/pull/11405)) - [murrant](https://github.com/murrant)
* Update on OS only logo. ([#11399](https://github.com/jadounrahul/kartsnms/pull/11399)) - [dneto82](https://github.com/dneto82)
* Updated panos.svg ([#11398](https://github.com/jadounrahul/kartsnms/pull/11398)) - [dneto82](https://github.com/dneto82)
* Fix global search by IP ([#11395](https://github.com/jadounrahul/kartsnms/pull/11395)) - [murrant](https://github.com/murrant)
* Clarify that you can use IP or hostname to add a device ([#11393](https://github.com/jadounrahul/kartsnms/pull/11393)) - [murrant](https://github.com/murrant)
* Widget Eventlog Sensors Link and Mouseover functionality ([#11380](https://github.com/jadounrahul/kartsnms/pull/11380)) - [SourceDoctor](https://github.com/SourceDoctor)
* Convert alert modals to blade ([#11373](https://github.com/jadounrahul/kartsnms/pull/11373)) - [Jellyfrog](https://github.com/Jellyfrog)
* Display custom types as in the config file (with ucwords) ([#11367](https://github.com/jadounrahul/kartsnms/pull/11367)) - [murrant](https://github.com/murrant)
* Geo map: check if lat/long exist for each device with link ([#11366](https://github.com/jadounrahul/kartsnms/pull/11366)) - [willhseitz](https://github.com/willhseitz)
* Fix shared dashboards missing users ([#11365](https://github.com/jadounrahul/kartsnms/pull/11365)) - [murrant](https://github.com/murrant)
* Protect against plugins that leak output ([#11364](https://github.com/jadounrahul/kartsnms/pull/11364)) - [murrant](https://github.com/murrant)
* Toggle visibilty of Dashboard Editor ([#11321](https://github.com/jadounrahul/kartsnms/pull/11321)) - [SourceDoctor](https://github.com/SourceDoctor)
* Honoring config option `force_ip_to_sysname` in bill creation and editing ([#10382](https://github.com/jadounrahul/kartsnms/pull/10382)) - [TvL2386](https://github.com/TvL2386)

#### Applications
* Change stats file location (Bind9) ([#11439](https://github.com/jadounrahul/kartsnms/pull/11439)) - [AltiUP](https://github.com/AltiUP)
* Rrdcached Socket Check fix ([#11372](https://github.com/jadounrahul/kartsnms/pull/11372)) - [SourceDoctor](https://github.com/SourceDoctor)
* Get configured Rrdcached Socket from config ([#11351](https://github.com/jadounrahul/kartsnms/pull/11351)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix memcached always reporting "ERROR" for app_state ([#10739](https://github.com/jadounrahul/kartsnms/pull/10739)) - [willhseitz](https://github.com/willhseitz)

#### Api
* BGP API: fix search by ipv6 when using compressed addresses ([#11394](https://github.com/jadounrahul/kartsnms/pull/11394)) - [kedare](https://github.com/kedare)
* BGP API: Allow to filter by local and remote peer address. ([#11340](https://github.com/jadounrahul/kartsnms/pull/11340)) - [kedare](https://github.com/kedare)

#### Alerting
* PagerDuty Transport Improvement ([#11459](https://github.com/jadounrahul/kartsnms/pull/11459)) - [h-barnhart](https://github.com/h-barnhart)
* Add support for sending events to Sensu ([#11383](https://github.com/jadounrahul/kartsnms/pull/11383)) - [TheMysteriousX](https://github.com/TheMysteriousX)
* Adding Column ifSpeed_prev, ifHighSpeed_prev to Ports Table ([#11348](https://github.com/jadounrahul/kartsnms/pull/11348)) - [SourceDoctor](https://github.com/SourceDoctor)
* Add transport for Smsmode (SMS provider) ([#11332](https://github.com/jadounrahul/kartsnms/pull/11332)) - [AnaelMobilia](https://github.com/AnaelMobilia)

#### Billing
* Fix billing graphs: work around jpgraph bug ([#11425](https://github.com/jadounrahul/kartsnms/pull/11425)) - [murrant](https://github.com/murrant)

#### Discovery
* Cisco sensor discovery fixes ([#11077](https://github.com/jadounrahul/kartsnms/pull/11077)) - [robwilkes](https://github.com/robwilkes)

#### Polling
* BGP Polling: Add error code management ([#11424](https://github.com/jadounrahul/kartsnms/pull/11424)) - [kedare](https://github.com/kedare)
* Fix device creation using overwrited ip ([#11388](https://github.com/jadounrahul/kartsnms/pull/11388)) - [Alex131089](https://github.com/Alex131089)
* Fix adsl graphs ([#11379](https://github.com/jadounrahul/kartsnms/pull/11379)) - [murrant](https://github.com/murrant)
* Fix rrd format issues for asterisk and cipsec-tunnels ([#11375](https://github.com/jadounrahul/kartsnms/pull/11375)) - [murrant](https://github.com/murrant)
* Patch unix agent ([#11312](https://github.com/jadounrahul/kartsnms/pull/11312)) - [TFujiwara](https://github.com/TFujiwara)
* Fixed race conditions in distributed poller setup ([#11307](https://github.com/jadounrahul/kartsnms/pull/11307)) - [vsessink](https://github.com/vsessink)
* Fix 10853 os specific syslocation ([#11082](https://github.com/jadounrahul/kartsnms/pull/11082)) - [willhseitz](https://github.com/willhseitz)

#### Bug
* Customer graphs: fix evaluation order so unauthenticated access works ([#11485](https://github.com/jadounrahul/kartsnms/pull/11485)) - [Zaxmy](https://github.com/Zaxmy)
* Fix case sensitiv translations ([#11463](https://github.com/jadounrahul/kartsnms/pull/11463)) - [Jellyfrog](https://github.com/Jellyfrog)
* Missed one jpgraph string ([#11447](https://github.com/jadounrahul/kartsnms/pull/11447)) - [murrant](https://github.com/murrant)
* Alert rule in, not_in remove ([#11437](https://github.com/jadounrahul/kartsnms/pull/11437)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix a copy-n-paste error ([#11429](https://github.com/jadounrahul/kartsnms/pull/11429)) - [robje](https://github.com/robje)
* Fix - Read the db_port as integer ([#11392](https://github.com/jadounrahul/kartsnms/pull/11392)) - [danislav](https://github.com/danislav)
* Fix dashboard html escaping and javascript redirect ([#11370](https://github.com/jadounrahul/kartsnms/pull/11370)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Refactor
* Cleanup unused code ([#11391](https://github.com/jadounrahul/kartsnms/pull/11391)) - [SourceDoctor](https://github.com/SourceDoctor)
* Delete ports via eloquent event ([#11354](https://github.com/jadounrahul/kartsnms/pull/11354)) - [murrant](https://github.com/murrant)
* Convert overview page to laravel ([#10757](https://github.com/jadounrahul/kartsnms/pull/10757)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Cleanup
* Update php-codesniffer ([#11368](https://github.com/jadounrahul/kartsnms/pull/11368)) - [murrant](https://github.com/murrant)

#### Documentation
* Add ASP sms provider ([#11489](https://github.com/jadounrahul/kartsnms/pull/11489)) - [Cormoran96](https://github.com/Cormoran96)
* Created installation for Debian 10 ([#11481](https://github.com/jadounrahul/kartsnms/pull/11481)) - [stylersnico](https://github.com/stylersnico)
* Add php-opcache settings to Performance Tuning ([#11452](https://github.com/jadounrahul/kartsnms/pull/11452)) - [hanserasmus](https://github.com/hanserasmus)
* Updated selected-port-polling explanation ([#11435](https://github.com/jadounrahul/kartsnms/pull/11435)) - [hanserasmus](https://github.com/hanserasmus)
* Update Images.md ([#11418](https://github.com/jadounrahul/kartsnms/pull/11418)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Fix RRDTune.md ([#11369](https://github.com/jadounrahul/kartsnms/pull/11369)) - [jozefrebjak](https://github.com/jozefrebjak)

#### Tests
* Addhost tests ([#11385](https://github.com/jadounrahul/kartsnms/pull/11385)) - [nimrof](https://github.com/nimrof)

#### Misc
* Set PHP 7.2.5 as minimum supported version ([#11470](https://github.com/jadounrahul/kartsnms/pull/11470)) - [Jellyfrog](https://github.com/Jellyfrog)
* Show full path to ini file for timezone validation failures ([#11444](https://github.com/jadounrahul/kartsnms/pull/11444)) - [murrant](https://github.com/murrant)
* Global setting better naming ([#11412](https://github.com/jadounrahul/kartsnms/pull/11412)) - [SourceDoctor](https://github.com/SourceDoctor)
* Updated MIB from Palo Alto ([#11402](https://github.com/jadounrahul/kartsnms/pull/11402)) - [dneto82](https://github.com/dneto82)
* Update PHP dependencies ([#11377](https://github.com/jadounrahul/kartsnms/pull/11377)) - [murrant](https://github.com/murrant)
...
#### Feature
* Geographical map: Show network links between locations ([#11269](https://github.com/jadounrahul/kartsnms/pull/11269)) - [kedare](https://github.com/kedare)
* Extra VLAN mapping in bridge FDB module to fix ProCurve ([#11230](https://github.com/jadounrahul/kartsnms/pull/11230)) - [cjwbath](https://github.com/cjwbath)

#### Device
* Add support for VOSS switches VSP-7400-48Y-8C and VSP-4900-48P ([#11360](https://github.com/jadounrahul/kartsnms/pull/11360)) - [ospfbgp](https://github.com/ospfbgp)
* Changed USV bypass state from alert to warning ([#11356](https://github.com/jadounrahul/kartsnms/pull/11356)) - [mpikzink](https://github.com/mpikzink)
* Cisco-Remote-Access-Monitor ([#11355](https://github.com/jadounrahul/kartsnms/pull/11355)) - [mpikzink](https://github.com/mpikzink)
* Added support for Cisco Firepower FTD 4140 ([#11345](https://github.com/jadounrahul/kartsnms/pull/11345)) - [chrisocalypse](https://github.com/chrisocalypse)
* Create MAS-MIB-SMIV2-MIB ([#11342](https://github.com/jadounrahul/kartsnms/pull/11342)) - [jp-asdf](https://github.com/jp-asdf)
* Sonus became Ribbon Communications - update logos ([#11339](https://github.com/jadounrahul/kartsnms/pull/11339)) - [cjwbath](https://github.com/cjwbath)
* Added cisco firepower threat defense 1120 ([#11336](https://github.com/jadounrahul/kartsnms/pull/11336)) - [lucadefazio](https://github.com/lucadefazio)
* Ubiquiti Edgepower OS definition ([#11315](https://github.com/jadounrahul/kartsnms/pull/11315)) - [jepke](https://github.com/jepke)
* Fixed issue with reporting of Cisco ASA Remote Sessions. rev2 ([#11286](https://github.com/jadounrahul/kartsnms/pull/11286)) - [dagbdagb](https://github.com/dagbdagb)
* Update Sophos detection ([#11275](https://github.com/jadounrahul/kartsnms/pull/11275)) - [murrant](https://github.com/murrant)
* Add support for Cisco SX350X-24 ([#11272](https://github.com/jadounrahul/kartsnms/pull/11272)) - [Chewza](https://github.com/Chewza)
* Add device support for SilverPeak ([#11270](https://github.com/jadounrahul/kartsnms/pull/11270)) - [shepherdjay](https://github.com/shepherdjay)
* Update OPNsense definition due to incorrect OID on second detection method ([#11265](https://github.com/jadounrahul/kartsnms/pull/11265)) - [FingerlessGlov3s](https://github.com/FingerlessGlov3s)
* Added additional Cisco FirePOWER device ID's for 2100 series ([#11260](https://github.com/jadounrahul/kartsnms/pull/11260)) - [ghost](https://github.com/ghost)
* Fix "inteno" and "quanta" OS collision ([#11238](https://github.com/jadounrahul/kartsnms/pull/11238)) - [PipoCanaja](https://github.com/PipoCanaja)
* Collect average server CPU usage on Huawei RH servers (IBMC) ([#11236](https://github.com/jadounrahul/kartsnms/pull/11236)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added support for Inteno devices ([#11229](https://github.com/jadounrahul/kartsnms/pull/11229)) - [PipoCanaja](https://github.com/PipoCanaja)
* Store OLD-CISCO-xxx-MIB files in their directory ([#11228](https://github.com/jadounrahul/kartsnms/pull/11228)) - [PipoCanaja](https://github.com/PipoCanaja)
* Add Device: Innovaphone ([#11225](https://github.com/jadounrahul/kartsnms/pull/11225)) - [mpikzink](https://github.com/mpikzink)

#### Webui
* QueryBuilder Filter alphabetic sorting ([#11358](https://github.com/jadounrahul/kartsnms/pull/11358)) - [SourceDoctor](https://github.com/SourceDoctor)
* Don't show deleted ports in device overview ([#11344](https://github.com/jadounrahul/kartsnms/pull/11344)) - [murrant](https://github.com/murrant)
* Top Interfaces, exclude invalid ports ([#11338](https://github.com/jadounrahul/kartsnms/pull/11338)) - [murrant](https://github.com/murrant)
* Fix invalid paths introduced in kartsnms/kartsnms#9883 ([#11337](https://github.com/jadounrahul/kartsnms/pull/11337)) - [fusedsynapse](https://github.com/fusedsynapse)
* Global Settings - force_ip_to_sysname, force_hostname_to_sysname ([#11335](https://github.com/jadounrahul/kartsnms/pull/11335)) - [SourceDoctor](https://github.com/SourceDoctor)
* Use format_hostname in dependencies list ([#11333](https://github.com/jadounrahul/kartsnms/pull/11333)) - [PipoCanaja](https://github.com/PipoCanaja)
* Better map link scaling algorithm ([#11329](https://github.com/jadounrahul/kartsnms/pull/11329)) - [kedare](https://github.com/kedare)
* Widget - TopInterface, TopDevice - device popup missing os name ([#11325](https://github.com/jadounrahul/kartsnms/pull/11325)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix js warning in settings, update js deps ([#11324](https://github.com/jadounrahul/kartsnms/pull/11324)) - [murrant](https://github.com/murrant)
* Replace AES by SHA for authalgo ([#11314](https://github.com/jadounrahul/kartsnms/pull/11314)) - [dGs-](https://github.com/dGs-)
* Widget Fix - Server Stats - show DisplayName instead Device ID ([#11301](https://github.com/jadounrahul/kartsnms/pull/11301)) - [SourceDoctor](https://github.com/SourceDoctor)
* Widget - show selected DeviceGroup in Title ([#11299](https://github.com/jadounrahul/kartsnms/pull/11299)) - [SourceDoctor](https://github.com/SourceDoctor)
* Builder View Fix for Collection Selector ([#11290](https://github.com/jadounrahul/kartsnms/pull/11290)) - [SourceDoctor](https://github.com/SourceDoctor)
* Form csrf missing in custom_oid edit ([#11282](https://github.com/jadounrahul/kartsnms/pull/11282)) - [danislav](https://github.com/danislav)
* Sort Settings by translated names ([#11280](https://github.com/jadounrahul/kartsnms/pull/11280)) - [murrant](https://github.com/murrant)
* Rewrite Poller Management to Blade/Eloquent ([#11277](https://github.com/jadounrahul/kartsnms/pull/11277)) - [SourceDoctor](https://github.com/SourceDoctor)
* Add datastore settings to the Web UI ([#11266](https://github.com/jadounrahul/kartsnms/pull/11266)) - [murrant](https://github.com/murrant)
* Show the plugin's name in the title rather than just "Plugin" ([#11258](https://github.com/jadounrahul/kartsnms/pull/11258)) - [cjwbath](https://github.com/cjwbath)
* Global Search - IPv4, IPv6 ([#11257](https://github.com/jadounrahul/kartsnms/pull/11257)) - [SourceDoctor](https://github.com/SourceDoctor)
* Extended unbound monitoring ([#11255](https://github.com/jadounrahul/kartsnms/pull/11255)) - [hanserasmus](https://github.com/hanserasmus)

#### Graphs
* Fix graph previous with rrdgraph_real_percentile ([#11306](https://github.com/jadounrahul/kartsnms/pull/11306)) - [murrant](https://github.com/murrant)
* Graph CPU Steal and IO Wait ([#11235](https://github.com/jadounrahul/kartsnms/pull/11235)) - [SourceDoctor](https://github.com/SourceDoctor)

#### Applications
* Fix issue when field name is longer than allowed ([#11349](https://github.com/jadounrahul/kartsnms/pull/11349)) - [murrant](https://github.com/murrant)
* Mailcow-dockerized postfix stats ([#11058](https://github.com/jadounrahul/kartsnms/pull/11058)) - [crcro](https://github.com/crcro)

#### Api
* Fix bills api percentage calculation with cdr/quota of zero ([#11352](https://github.com/jadounrahul/kartsnms/pull/11352)) - [Urth](https://github.com/Urth)

#### Alerting
* Alert Rule - add Operator 'in' and 'not in' ([#11327](https://github.com/jadounrahul/kartsnms/pull/11327)) - [SourceDoctor](https://github.com/SourceDoctor)
* Alert Collection Rule - APC UPS Diagnostics Test Result ([#11292](https://github.com/jadounrahul/kartsnms/pull/11292)) - [SourceDoctor](https://github.com/SourceDoctor)
* Alert Collection Rule fix for APC on Battery Power ([#11291](https://github.com/jadounrahul/kartsnms/pull/11291)) - [SourceDoctor](https://github.com/SourceDoctor)

#### Billing
* Fix bills api output for period=previous ([#11295](https://github.com/jadounrahul/kartsnms/pull/11295)) - [Urth](https://github.com/Urth)

#### Discovery
* Fix autodiscovery vs discovery on LLDP/xDP links ([#11189](https://github.com/jadounrahul/kartsnms/pull/11189)) - [kedare](https://github.com/kedare)

#### Polling
* Fixed Netscaler vserver rrd ds name ([#11304](https://github.com/jadounrahul/kartsnms/pull/11304)) - [pobradovic08](https://github.com/pobradovic08)
* Refactor Datastores to allow future improvements. OpenTSDB Tags. ([#11283](https://github.com/jadounrahul/kartsnms/pull/11283)) - [murrant](https://github.com/murrant)
* Fallback to default Poller Group on delete ([#11278](https://github.com/jadounrahul/kartsnms/pull/11278)) - [SourceDoctor](https://github.com/SourceDoctor)
* Upgrade UCD Mibs (Others) ([#11253](https://github.com/jadounrahul/kartsnms/pull/11253)) - [Munzy](https://github.com/Munzy)
* Update Linux SNMPD to support ssCpuRawSteal ([#11252](https://github.com/jadounrahul/kartsnms/pull/11252)) - [Munzy](https://github.com/Munzy)
* Changed poller member validation step and message ([#11239](https://github.com/jadounrahul/kartsnms/pull/11239)) - [joseUPV](https://github.com/joseUPV)

#### Bug
* Add primary key to device_graphs ([#11331](https://github.com/jadounrahul/kartsnms/pull/11331)) - [rkojedzinszky](https://github.com/rkojedzinszky)
* Stop using {} for arrays ([#11319](https://github.com/jadounrahul/kartsnms/pull/11319)) - [dlangille](https://github.com/dlangille)
* Only check depedencies once in validate.php ([#11316](https://github.com/jadounrahul/kartsnms/pull/11316)) - [murrant](https://github.com/murrant)
* Fix get_rrd_dir() function ([#11310](https://github.com/jadounrahul/kartsnms/pull/11310)) - [murrant](https://github.com/murrant)
* Fix show rrdtool command ([#11305](https://github.com/jadounrahul/kartsnms/pull/11305)) - [murrant](https://github.com/murrant)
* Fix custom oids not being added to RRD after other RRD cleanups ([#11300](https://github.com/jadounrahul/kartsnms/pull/11300)) - [ekoyle](https://github.com/ekoyle)
* Fix db_port config in services-wrapper ([#11284](https://github.com/jadounrahul/kartsnms/pull/11284)) - [danislav](https://github.com/danislav)
* Fix - Crash in Device Group on some Operator ([#11250](https://github.com/jadounrahul/kartsnms/pull/11250)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix error when deleting alert maintenance schedules ([#11232](https://github.com/jadounrahul/kartsnms/pull/11232)) - [josephtingiris](https://github.com/josephtingiris)

#### Cleanup
* Symfony requires php-dom extension ([#11320](https://github.com/jadounrahul/kartsnms/pull/11320)) - [nickhilliard](https://github.com/nickhilliard)

#### Documentation
* Update SNMP-Configuration-Examples.md ([#11334](https://github.com/jadounrahul/kartsnms/pull/11334)) - [dagbdagb](https://github.com/dagbdagb)
* Update SMART extension documentation ([#11330](https://github.com/jadounrahul/kartsnms/pull/11330)) - [raphaelyancey](https://github.com/raphaelyancey)
* Update Performance.md ([#11298](https://github.com/jadounrahul/kartsnms/pull/11298)) - [dagbdagb](https://github.com/dagbdagb)
* Update Dispatcher-Service.md ([#11297](https://github.com/jadounrahul/kartsnms/pull/11297)) - [dagbdagb](https://github.com/dagbdagb)
* Fix dockerized postfix app wrong url ([#11285](https://github.com/jadounrahul/kartsnms/pull/11285)) - [jozefrebjak](https://github.com/jozefrebjak)
* Add quotes around the word mail ([#11267](https://github.com/jadounrahul/kartsnms/pull/11267)) - [danislav](https://github.com/danislav)
* Update SNMP-Trap-Handler.md ([#11263](https://github.com/jadounrahul/kartsnms/pull/11263)) - [jozefrebjak](https://github.com/jozefrebjak)
* Fix includes/defaults.inc.php references ([#11249](https://github.com/jadounrahul/kartsnms/pull/11249)) - [dlangille](https://github.com/dlangille)
* Update SSL-Configuration.md ([#11223](https://github.com/jadounrahul/kartsnms/pull/11223)) - [fhlmbrg](https://github.com/fhlmbrg)
* Health Sensor Advanced Discovery Example ([#11179](https://github.com/jadounrahul/kartsnms/pull/11179)) - [h-barnhart](https://github.com/h-barnhart)

#### Translation
* French translation update ([#11293](https://github.com/jadounrahul/kartsnms/pull/11293)) - [PipoCanaja](https://github.com/PipoCanaja)
...
#### Feature
* Option to default open Location Map on Device View ([#11167](https://github.com/jadounrahul/kartsnms/pull/11167)) - [SourceDoctor](https://github.com/SourceDoctor)
* Community 10946, Option -r for ping.php ([#11161](https://github.com/jadounrahul/kartsnms/pull/11161)) - [danislav](https://github.com/danislav)
* Extra VLAN mapping in AOS specific FDB module ([#11145](https://github.com/jadounrahul/kartsnms/pull/11145)) - [joseUPV](https://github.com/joseUPV)
* Puppet Agent Monitoring ([#10827](https://github.com/jadounrahul/kartsnms/pull/10827)) - [SourceDoctor](https://github.com/SourceDoctor)

#### Device
* Aruba cluster userfriendly read ([#11217](https://github.com/jadounrahul/kartsnms/pull/11217)) - [mpikzink](https://github.com/mpikzink)
* IOSXE ignore macSecControlledIF and macSecUncontrolledIF ifTypes ([#11214](https://github.com/jadounrahul/kartsnms/pull/11214)) - [pepperoni-pi](https://github.com/pepperoni-pi)
* Additional OPNsense detection ([#11196](https://github.com/jadounrahul/kartsnms/pull/11196)) - [FingerlessGlov3s](https://github.com/FingerlessGlov3s)
* Added Cambium PTP670 ([#11186](https://github.com/jadounrahul/kartsnms/pull/11186)) - [PipoCanaja](https://github.com/PipoCanaja)
* Add basic support for PICA8 devices ([#11185](https://github.com/jadounrahul/kartsnms/pull/11185)) - [PipoCanaja](https://github.com/PipoCanaja)
* Add the serial to aruba-instant devices ([#11184](https://github.com/jadounrahul/kartsnms/pull/11184)) - [mpikzink](https://github.com/mpikzink)
* Huawei MIB updates ([#11181](https://github.com/jadounrahul/kartsnms/pull/11181)) - [PipoCanaja](https://github.com/PipoCanaja)
* Adva FSP150cc Health Sensors ([#11168](https://github.com/jadounrahul/kartsnms/pull/11168)) - [h-barnhart](https://github.com/h-barnhart)
* Add support for reading advertised BGP prefixes ([#11147](https://github.com/jadounrahul/kartsnms/pull/11147)) - [kedare](https://github.com/kedare)
* Bug - Correct RFC1213 route discovery ([#11144](https://github.com/jadounrahul/kartsnms/pull/11144)) - [PipoCanaja](https://github.com/PipoCanaja)
* Aruba Controller -\>Correct AP Power value ([#11122](https://github.com/jadounrahul/kartsnms/pull/11122)) - [joseUPV](https://github.com/joseUPV)
* Support for Teldat routers ([#11118](https://github.com/jadounrahul/kartsnms/pull/11118)) - [PipoCanaja](https://github.com/PipoCanaja)
* Add serial to Epson printer ([#11111](https://github.com/jadounrahul/kartsnms/pull/11111)) - [mpikzink](https://github.com/mpikzink)
* Add Janitza Power Sensors ([#11110](https://github.com/jadounrahul/kartsnms/pull/11110)) - [mpikzink](https://github.com/mpikzink)
* Add Serialnumber to HP und Konica printers ([#11106](https://github.com/jadounrahul/kartsnms/pull/11106)) - [mpikzink](https://github.com/mpikzink)
* Adding support for Cisco SB SX550X-24F switch ([#11098](https://github.com/jadounrahul/kartsnms/pull/11098)) - [Pluppo](https://github.com/Pluppo)
* Added rittal-cmc (LCP Plus) ([#11091](https://github.com/jadounrahul/kartsnms/pull/11091)) - [mpikzink](https://github.com/mpikzink)
* Improve Huawei VRP bgp discovery ([#11054](https://github.com/jadounrahul/kartsnms/pull/11054)) - [PipoCanaja](https://github.com/PipoCanaja)

#### Webui
* Running Alerts colorized depending on to their severity ([#11210](https://github.com/jadounrahul/kartsnms/pull/11210)) - [SourceDoctor](https://github.com/SourceDoctor)
* Dashboard Widget Availability - show Hostname ([#11208](https://github.com/jadounrahul/kartsnms/pull/11208)) - [SourceDoctor](https://github.com/SourceDoctor)
* Move storage module settings to discovery tab ([#11206](https://github.com/jadounrahul/kartsnms/pull/11206)) - [murrant](https://github.com/murrant)
* Update JS deps ([#11203](https://github.com/jadounrahul/kartsnms/pull/11203)) - [murrant](https://github.com/murrant)
* Fix global settings array validate messages ([#11199](https://github.com/jadounrahul/kartsnms/pull/11199)) - [murrant](https://github.com/murrant)
* Global Settings - Uptime Warning ([#11198](https://github.com/jadounrahul/kartsnms/pull/11198)) - [SourceDoctor](https://github.com/SourceDoctor)
* Global Settings - Mountpoint ignore options ([#11197](https://github.com/jadounrahul/kartsnms/pull/11197)) - [SourceDoctor](https://github.com/SourceDoctor)
* Global search by IP address ([#11165](https://github.com/jadounrahul/kartsnms/pull/11165)) - [josephtingiris](https://github.com/josephtingiris)
* Add Size column to edit Storage Settings table ([#11164](https://github.com/jadounrahul/kartsnms/pull/11164)) - [josephtingiris](https://github.com/josephtingiris)
* Equalize default Poller Group Naming ([#11156](https://github.com/jadounrahul/kartsnms/pull/11156)) - [SourceDoctor](https://github.com/SourceDoctor)
* Configurable Alert Rule default settings ([#11152](https://github.com/jadounrahul/kartsnms/pull/11152)) - [SourceDoctor](https://github.com/SourceDoctor)
* Change Device, Group, Location - Order ([#11141](https://github.com/jadounrahul/kartsnms/pull/11141)) - [SourceDoctor](https://github.com/SourceDoctor)
* Alert Rule label fix ([#11137](https://github.com/jadounrahul/kartsnms/pull/11137)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix android-chrome icons ([#11136](https://github.com/jadounrahul/kartsnms/pull/11136)) - [josephtingiris](https://github.com/josephtingiris)
* Update devices last_ping along with device_perf ([#11117](https://github.com/jadounrahul/kartsnms/pull/11117)) - [josephtingiris](https://github.com/josephtingiris)
* Renovated Alert Rules ([#11115](https://github.com/jadounrahul/kartsnms/pull/11115)) - [josephtingiris](https://github.com/josephtingiris)
* Fix inventory page hostname/sysname and default generate_device_link behaviour ([#11114](https://github.com/jadounrahul/kartsnms/pull/11114)) - [kedare](https://github.com/kedare)
* Hide "devices added" for devices that existed before #11104 ([#11107](https://github.com/jadounrahul/kartsnms/pull/11107)) - [josephtingiris](https://github.com/josephtingiris)
* Add a space for times like '1 minute' ([#11105](https://github.com/jadounrahul/kartsnms/pull/11105)) - [josephtingiris](https://github.com/josephtingiris)
* Show when a device was added and last discovered ([#11104](https://github.com/jadounrahul/kartsnms/pull/11104)) - [josephtingiris](https://github.com/josephtingiris)
* Speed up canAccessDevice/devicesForUser ([#10992](https://github.com/jadounrahul/kartsnms/pull/10992)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Api
* BGP API: Add filter by remote ASN ([#11204](https://github.com/jadounrahul/kartsnms/pull/11204)) - [kedare](https://github.com/kedare)
* Add alert_rule filtering to API ROUTE "list_alerts" ([#11109](https://github.com/jadounrahul/kartsnms/pull/11109)) - [gcotone](https://github.com/gcotone)
* Added add and remove parents for device from the V0 API ([#11100](https://github.com/jadounrahul/kartsnms/pull/11100)) - [gabrielRojasNew](https://github.com/gabrielRojasNew)
* Created add, edit, remove location and edit, remove services to the v… ([#11080](https://github.com/jadounrahul/kartsnms/pull/11080)) - [gabrielRojasNew](https://github.com/gabrielRojasNew)

#### Alerting
* Copy existing Alert Rule ([#11195](https://github.com/jadounrahul/kartsnms/pull/11195)) - [SourceDoctor](https://github.com/SourceDoctor)
* More verbose Alert Detail Fallback ([#11153](https://github.com/jadounrahul/kartsnms/pull/11153)) - [SourceDoctor](https://github.com/SourceDoctor)
* Alert Rule default update ([#11143](https://github.com/jadounrahul/kartsnms/pull/11143)) - [SourceDoctor](https://github.com/SourceDoctor)
* Ping Latency Check to Alert Collection ([#11139](https://github.com/jadounrahul/kartsnms/pull/11139)) - [SourceDoctor](https://github.com/SourceDoctor)
* Location based Alert Rule ([#11128](https://github.com/jadounrahul/kartsnms/pull/11128)) - [SourceDoctor](https://github.com/SourceDoctor)
* Default alert rules remove Devices up/down ([#11124](https://github.com/jadounrahul/kartsnms/pull/11124)) - [kkrumm1](https://github.com/kkrumm1)

#### Discovery
* MPLS Route discovery - Wrong variable assignation order ([#11103](https://github.com/jadounrahul/kartsnms/pull/11103)) - [PipoCanaja](https://github.com/PipoCanaja)

#### Polling
* Reduce DB polling while getting SNMP data ([#11162](https://github.com/jadounrahul/kartsnms/pull/11162)) - [SourceDoctor](https://github.com/SourceDoctor)
* Mark assigned default Poller Group ([#11112](https://github.com/jadounrahul/kartsnms/pull/11112)) - [SourceDoctor](https://github.com/SourceDoctor)
* Change Poller time validation ([#11108](https://github.com/jadounrahul/kartsnms/pull/11108)) - [joseUPV](https://github.com/joseUPV)

#### Bug
* Device Page: Remove csrf token from url when updating url ([#11180](https://github.com/jadounrahul/kartsnms/pull/11180)) - [murrant](https://github.com/murrant)
* Space on type like "OOB Management" cause issue on smokeping, edit ge… ([#11160](https://github.com/jadounrahul/kartsnms/pull/11160)) - [joretapoo](https://github.com/joretapoo)
* Invalidate 'Wrong Type' snmp_walk() data ([#11159](https://github.com/jadounrahul/kartsnms/pull/11159)) - [josephtingiris](https://github.com/josephtingiris)
* Fix invalid dnos test data ([#11158](https://github.com/jadounrahul/kartsnms/pull/11158)) - [murrant](https://github.com/murrant)
* Fix SSO Auth test ([#11155](https://github.com/jadounrahul/kartsnms/pull/11155)) - [murrant](https://github.com/murrant)
* PHP hashes are case sensitive. ([#11151](https://github.com/jadounrahul/kartsnms/pull/11151)) - [wikro](https://github.com/wikro)
* Change ups-nut sensors ([#11113](https://github.com/jadounrahul/kartsnms/pull/11113)) - [mpikzink](https://github.com/mpikzink)
* Fixed unix-agent polling bug where the called method can't be found ([#11102](https://github.com/jadounrahul/kartsnms/pull/11102)) - [lehuizi](https://github.com/lehuizi)

#### Documentation
* Correct docs menu name ([#11207](https://github.com/jadounrahul/kartsnms/pull/11207)) - [Jellyfrog](https://github.com/Jellyfrog)
* Added documentation to edit, delete services and locations ([#11193](https://github.com/jadounrahul/kartsnms/pull/11193)) - [gabrielRojasNew](https://github.com/gabrielRojasNew)
* Added steps to split DB off to its own server ([#11130](https://github.com/jadounrahul/kartsnms/pull/11130)) - [SourceDoctor](https://github.com/SourceDoctor)
* Added yum-config-manager to Remi install ([#11033](https://github.com/jadounrahul/kartsnms/pull/11033)) - [Atroskelis](https://github.com/Atroskelis)

#### Translation
* Update settings.php translation string ([#10928](https://github.com/jadounrahul/kartsnms/pull/10928)) - [jasoncheng7115](https://github.com/jasoncheng7115)

#### Misc
* Validate that php sockets is available ([#11177](https://github.com/jadounrahul/kartsnms/pull/11177)) - [murrant](https://github.com/murrant)
...
#### Feature
* Maintenance Mode for a complete Location ([#11089](https://github.com/jadounrahul/kartsnms/pull/11089)) - [SourceDoctor](https://github.com/SourceDoctor)
* Alternate Poller IP instead of Hostname ([#10981](https://github.com/jadounrahul/kartsnms/pull/10981)) - [SourceDoctor](https://github.com/SourceDoctor)

#### Device
* Fixed missing PoE graphs for Cisco devices ([#11087](https://github.com/jadounrahul/kartsnms/pull/11087)) - [ajsiersema](https://github.com/ajsiersema)
* Fix Air Fiber port stats ([#11079](https://github.com/jadounrahul/kartsnms/pull/11079)) - [murrant](https://github.com/murrant)
* Added OS definition and discovery for SIAE Alfo80HD ([#11063](https://github.com/jadounrahul/kartsnms/pull/11063)) - [HostIRE](https://github.com/HostIRE)
* Added WUT Humidity and Temperature Sensors ([#11053](https://github.com/jadounrahul/kartsnms/pull/11053)) - [mpikzink](https://github.com/mpikzink)
* Create CISCO-RESILIENT-ETHERNET-PROTOCOL-MIB ([#11052](https://github.com/jadounrahul/kartsnms/pull/11052)) - [opalivan](https://github.com/opalivan)
* Minor updates for dd-wrt, clarify snmp source better ([#11051](https://github.com/jadounrahul/kartsnms/pull/11051)) - [arrmo](https://github.com/arrmo)
* Add Zyxel MGS-3712 Sensors ([#11050](https://github.com/jadounrahul/kartsnms/pull/11050)) - [vitalisator](https://github.com/vitalisator)
* Update IOS-XR with NCS-5500 support ([#11044](https://github.com/jadounrahul/kartsnms/pull/11044)) - [zombah](https://github.com/zombah)
* Add sensors to Infoblox discovery (nios.yaml) ([#11043](https://github.com/jadounrahul/kartsnms/pull/11043)) - [JohnSPeach](https://github.com/JohnSPeach)
* Update timos.inc.php ([#11040](https://github.com/jadounrahul/kartsnms/pull/11040)) - [craig-nokia](https://github.com/craig-nokia)
* Fixed issue with SNMP contexts using vlan 1002-1005 on IOS devices ([#11031](https://github.com/jadounrahul/kartsnms/pull/11031)) - [nistorj](https://github.com/nistorj)
* Create TRIPPLITE-PRODUCTS ([#11028](https://github.com/jadounrahul/kartsnms/pull/11028)) - [arjitc](https://github.com/arjitc)
* Add support for TRENDnet switch ([#11007](https://github.com/jadounrahul/kartsnms/pull/11007)) - [arrmo](https://github.com/arrmo)
* Add ifotec definition file ([#11005](https://github.com/jadounrahul/kartsnms/pull/11005)) - [AnaelMobilia](https://github.com/AnaelMobilia)
* Correct preg_match() pattern on line 5 ([#10999](https://github.com/jadounrahul/kartsnms/pull/10999)) - [josephtingiris](https://github.com/josephtingiris)
* Fix Siklu Voltage Sensor ([#10997](https://github.com/jadounrahul/kartsnms/pull/10997)) - [joshuabaird](https://github.com/joshuabaird)
* Add state sensor for Packetflux Sitemonitor Switch Input ([#10994](https://github.com/jadounrahul/kartsnms/pull/10994)) - [joshuabaird](https://github.com/joshuabaird)
* Add Lancom OAP-321 Wireless AP ([#10982](https://github.com/jadounrahul/kartsnms/pull/10982)) - [vitalisator](https://github.com/vitalisator)
* Update IronWare sensors & bgp-peers discovery, allow skip_values to target a specific index appended to the OID ([#10941](https://github.com/jadounrahul/kartsnms/pull/10941)) - [martijn-schmidt](https://github.com/martijn-schmidt)
* FDB for ArubaOS ([#10940](https://github.com/jadounrahul/kartsnms/pull/10940)) - [klui2k1](https://github.com/klui2k1)
* Extend FS switches support, handle lowerLayerDown ifOperStatus ([#10904](https://github.com/jadounrahul/kartsnms/pull/10904)) - [PipoCanaja](https://github.com/PipoCanaja)

#### Webui
* Mark Devices in Maintenance Mode ([#11092](https://github.com/jadounrahul/kartsnms/pull/11092)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix missing ACK & Notes modals on device alert page ([#11076](https://github.com/jadounrahul/kartsnms/pull/11076)) - [josephtingiris](https://github.com/josephtingiris)
* Poller Group Management - Device Count ([#11073](https://github.com/jadounrahul/kartsnms/pull/11073)) - [SourceDoctor](https://github.com/SourceDoctor)
* Order Poller Group by Name ([#11072](https://github.com/jadounrahul/kartsnms/pull/11072)) - [SourceDoctor](https://github.com/SourceDoctor)
* Change Poller Group on Device Settings ([#11071](https://github.com/jadounrahul/kartsnms/pull/11071)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fixed device SNMP edit form (and better feedback) ([#11068](https://github.com/jadounrahul/kartsnms/pull/11068)) - [josephtingiris](https://github.com/josephtingiris)
* Oxidized GUI tweaks ([#11066](https://github.com/jadounrahul/kartsnms/pull/11066)) - [cjwbath](https://github.com/cjwbath)
* Add aggregate totals to multiport_bits graph, similar to port_bits ([#11065](https://github.com/jadounrahul/kartsnms/pull/11065)) - [willhseitz](https://github.com/willhseitz)
* Format the Device Module Naming like in global Settings ([#11061](https://github.com/jadounrahul/kartsnms/pull/11061)) - [SourceDoctor](https://github.com/SourceDoctor)
* Allow findOsImage() to also use the first two words of $feature ([#11049](https://github.com/jadounrahul/kartsnms/pull/11049)) - [josephtingiris](https://github.com/josephtingiris)
* Highlight Device Dependency Path to Dependency Root Device(s) ([#11025](https://github.com/jadounrahul/kartsnms/pull/11025)) - [SourceDoctor](https://github.com/SourceDoctor)
* Support of "disable alerting" in availability map and device summary widget ([#11022](https://github.com/jadounrahul/kartsnms/pull/11022)) - [louis-oui](https://github.com/louis-oui)
* Highlight isolated Devices (Devices with no Dependencies) ([#11018](https://github.com/jadounrahul/kartsnms/pull/11018)) - [SourceDoctor](https://github.com/SourceDoctor)
* Clarify doc and webui for ignore tag on devices, ports, components and services ([#11016](https://github.com/jadounrahul/kartsnms/pull/11016)) - [louis-oui](https://github.com/louis-oui)
* "Disable alerting" on device disables alert rules check (not just alert transport) ([#11015](https://github.com/jadounrahul/kartsnms/pull/11015)) - [louis-oui](https://github.com/louis-oui)
* Clarify disable, ignore and disable all alerts in device edit section ([#11011](https://github.com/jadounrahul/kartsnms/pull/11011)) - [louis-oui](https://github.com/louis-oui)
* Add Blade directives for common Url functions ([#10995](https://github.com/jadounrahul/kartsnms/pull/10995)) - [Jellyfrog](https://github.com/Jellyfrog)
* Alertlog stats dashboard widget ([#10967](https://github.com/jadounrahul/kartsnms/pull/10967)) - [louis-oui](https://github.com/louis-oui)
* Add alert rule option to invert devices and groups "map to" list ([#10954](https://github.com/jadounrahul/kartsnms/pull/10954)) - [louis-oui](https://github.com/louis-oui)
* Graphing Device Dependency ([#10916](https://github.com/jadounrahul/kartsnms/pull/10916)) - [SourceDoctor](https://github.com/SourceDoctor)
* Add 'alert history' widget for dashboard ([#10901](https://github.com/jadounrahul/kartsnms/pull/10901)) - [louis-oui](https://github.com/louis-oui)
* Discovery Module and Poller Module configuration via Global Settings Web GUI ([#10854](https://github.com/jadounrahul/kartsnms/pull/10854)) - [SourceDoctor](https://github.com/SourceDoctor)

#### Snmp Traps
* VMWare Guest State Traps and UI ([#11035](https://github.com/jadounrahul/kartsnms/pull/11035)) - [h-barnhart](https://github.com/h-barnhart)
* SNMP Traps for Juniper Power Supplies ([#10965](https://github.com/jadounrahul/kartsnms/pull/10965)) - [h-barnhart](https://github.com/h-barnhart)

#### Applications
* Show Alert Detail for Applications ([#11088](https://github.com/jadounrahul/kartsnms/pull/11088)) - [SourceDoctor](https://github.com/SourceDoctor)
* Asterisk app: add IAX2 peer graphs ([#11078](https://github.com/jadounrahul/kartsnms/pull/11078)) - [josephtingiris](https://github.com/josephtingiris)
* PureFTPd Application ([#11048](https://github.com/jadounrahul/kartsnms/pull/11048)) - [SourceDoctor](https://github.com/SourceDoctor)

#### Alerting
* Remove also Associations by deleting Scheduled Maintenance ([#11093](https://github.com/jadounrahul/kartsnms/pull/11093)) - [SourceDoctor](https://github.com/SourceDoctor)
* Remove redundant data from Alert fallback detail ([#11081](https://github.com/jadounrahul/kartsnms/pull/11081)) - [SourceDoctor](https://github.com/SourceDoctor)
* Cisco Spark Do not strip tags when markdown is in use. ([#11075](https://github.com/jadounrahul/kartsnms/pull/11075)) - [xorrkaz](https://github.com/xorrkaz)
* Added fix for escaping underscore while using Markdown ([#11070](https://github.com/jadounrahul/kartsnms/pull/11070)) - [SpaceDump](https://github.com/SpaceDump)
* Add alert rule option to invert devices and groups "map to" list ([#11038](https://github.com/jadounrahul/kartsnms/pull/11038)) - [louis-oui](https://github.com/louis-oui)
* Do not update alert timestamp when updating a triggered alert ([#10907](https://github.com/jadounrahul/kartsnms/pull/10907)) - [louis-oui](https://github.com/louis-oui)

#### Billing
* SNMP counters validation ([#11037](https://github.com/jadounrahul/kartsnms/pull/11037)) - [ccperilla](https://github.com/ccperilla)

#### Discovery
* Don't overwrite real port ids with zeros in the FDB ([#11041](https://github.com/jadounrahul/kartsnms/pull/11041)) - [cjwbath](https://github.com/cjwbath)
* Add bad_ifoperstatus for filtering interfaces having a status for example 'notPresent' ([#10977](https://github.com/jadounrahul/kartsnms/pull/10977)) - [LEV82](https://github.com/LEV82)

#### Polling
* Don't dnslookup if overwrite IP is configured ([#11084](https://github.com/jadounrahul/kartsnms/pull/11084)) - [SourceDoctor](https://github.com/SourceDoctor)
* Optimize DB update of ports and ports_statistics tables when polling ([#10792](https://github.com/jadounrahul/kartsnms/pull/10792)) - [louis-oui](https://github.com/louis-oui)

#### Bug
* Revert ironware BGP-peers changes from PR #10941 ([#11096](https://github.com/jadounrahul/kartsnms/pull/11096)) - [martijn-schmidt](https://github.com/martijn-schmidt)
* Fix snmptranslate exception ([#11085](https://github.com/jadounrahul/kartsnms/pull/11085)) - [josephtingiris](https://github.com/josephtingiris)
* Updated test data for arubaos, fs-switch, ifotec, lcos, siklu and trendnet, to pass Travis tests ([#11067](https://github.com/jadounrahul/kartsnms/pull/11067)) - [LEV82](https://github.com/LEV82)
* Fix FatalThrowableError in forgetAttrib() ([#11064](https://github.com/jadounrahul/kartsnms/pull/11064)) - [josephtingiris](https://github.com/josephtingiris)
* Fix SQL constraint violation, 'port_id' cannot be null ([#11055](https://github.com/jadounrahul/kartsnms/pull/11055)) - [josephtingiris](https://github.com/josephtingiris)
* Fix alerts not displayed ([#11034](https://github.com/jadounrahul/kartsnms/pull/11034)) - [louis-oui](https://github.com/louis-oui)
* Fix & amend broken $num_ports query on line 83 ([#11013](https://github.com/jadounrahul/kartsnms/pull/11013)) - [josephtingiris](https://github.com/josephtingiris)
* Bugfix the snmpsim collector: use the correct mibdir ([#11003](https://github.com/jadounrahul/kartsnms/pull/11003)) - [martijn-schmidt](https://github.com/martijn-schmidt)
* In rrdtool_escape(), fix invalid length ([#11001](https://github.com/jadounrahul/kartsnms/pull/11001)) - [josephtingiris](https://github.com/josephtingiris)

#### Refactor
* Centralize Application Display Naming ([#11047](https://github.com/jadounrahul/kartsnms/pull/11047)) - [SourceDoctor](https://github.com/SourceDoctor)
* Remove uneeded table header ([#11029](https://github.com/jadounrahul/kartsnms/pull/11029)) - [SourceDoctor](https://github.com/SourceDoctor)
* Always update widget seeds when db update ([#10917](https://github.com/jadounrahul/kartsnms/pull/10917)) - [louis-oui](https://github.com/louis-oui)

#### Cleanup
* Fixing PHP incompatibility issue with PHP 7.4 ([#11030](https://github.com/jadounrahul/kartsnms/pull/11030)) - [clmcavaney](https://github.com/clmcavaney)

#### Documentation
* SELinux fix for syslog-ng with KartsNMS on Centos ([#11014](https://github.com/jadounrahul/kartsnms/pull/11014)) - [dagbdagb](https://github.com/dagbdagb)

#### Translation
* Correct 'shortend' misspelling ([#11000](https://github.com/jadounrahul/kartsnms/pull/11000)) - [josephtingiris](https://github.com/josephtingiris)