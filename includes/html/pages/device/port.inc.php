...
if (KartsNMS\Plugins::countHooks('port_container') || \PluginManager::hasHooks(PortTabHook::class, ['port' => $portModel])) {
...
if (Auth::user()->hasGlobalAdmin() && \KartsNMS\Config::get('enable_billing') == 1) {
