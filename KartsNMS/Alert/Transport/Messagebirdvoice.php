 ...
 *
 * KartsNMS Messagebird voice API Tranport
 *
 ...
 *
 * Messagebird voice will return 201 status if the call was initiated, if status is not 201 KartsNMS will log the full error
 *
