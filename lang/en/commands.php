...
return [
    ...
    'dev:check' => [
        'description' => 'KartsNMS code checks. Running with no options runs all checks',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'The file name (only base name) of the snmprec file to update or add to KartsNMS. If file not specified, no device will be added or updated.',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'If you do not have the old key, you must delete all encrypted data to be able to continue to use certain KartsNMS features',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'For more information see https://docs.kartsnms.org/Extensions/Smokeping/"',
