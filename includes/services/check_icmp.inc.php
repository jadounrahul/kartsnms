...
$check_cmd = \KartsNMS\Config::get('nagios_plugins') . '/check_icmp ' . $service['service_param'] . ' ' . ($service['service_ip'] ? $service['service_ip'] : $service['hostname']);
...
$check_graph['rtt'] .= ' LINE1.25:DS0#' . \KartsNMS\Config::get('graph_colours.mixed.0') . ":'" . str_pad(substr('Round Trip Average', 0, 15), 15) . "' ";
...
$check_graph['rtt'] .= ' LINE1.25:DS1#' . \KartsNMS\Config::get('graph_colours.mixed.1') . ":'" . str_pad(substr('Round Trip Max', 0, 15), 15) . "' ";
...
$check_graph['rtt'] .= ' LINE1.25:DS2#' . \KartsNMS\Config::get('graph_colours.mixed.2') . ":'" . str_pad(substr('Round Trip Min', 0, 15), 15) . "' ";
...
$check_graph['pl'] .= ' AREA:DS0#' . \KartsNMS\Config::get('graph_colours.mixed.2') . ":'" . str_pad(substr('Packet Loss (%)', 0, 15), 15) . "' ";
