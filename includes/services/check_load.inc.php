...
$check_cmd = \KartsNMS\Config::get('nagios_plugins') . '/check_load ' . $params;
...
$check_graph['load'] .= ' LINE1.25:DS0#' . \KartsNMS\Config::get('graph_colours.mixed.0') . ":'" . str_pad(substr('Load 1', 0, 15), 15) . "' ";
...
$check_graph['load'] .= ' LINE1.25:DS1#' . \KartsNMS\Config::get('graph_colours.mixed.1') . ":'" . str_pad(substr('Load 5', 0, 15), 15) . "' ";
...
$check_graph['load'] .= ' LINE1.25:DS2#' . \KartsNMS\Config::get('graph_colours.mixed.2') . ":'" . str_pad(substr('Load 15', 0, 15), 15) . "' ";
