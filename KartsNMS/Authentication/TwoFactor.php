...
class TwoFactor
{
    ...
    {
        $title = 'KartsNMS:' . urlencode($username);

        return $counter ?
            "otpauth://hotp/$title?issuer=KartsNMS&counter=1&secret=$key" : // counter based
            "otpauth://totp/$title?issuer=KartsNMS&secret=$key"; // time based
    }
}
