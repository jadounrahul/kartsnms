...
namespace KartsNMS\Validations\Poller;

use Illuminate\Support\Facades\Redis;
use KartsNMS\ValidationResult;

class CheckRedis implements \KartsNMS\Interfaces\Validation
{
    /**
     * @inheritDoc
     */
    public function validate(): ValidationResult
    {
        ...
        if (\KartsNMS\Config::get('distributed_poller') && \App\Models\PollerCluster::isActive()->count() > 2) {
