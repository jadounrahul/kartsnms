...
foreach ($sensors as $index => $sensor) {
    ...
    $colour_index = $index % count(\KartsNMS\Config::get('graph_colours.mixed'));
    $colour = \KartsNMS\Config::get("graph_colours.mixed.$colour_index");

    $sensor_descr_fixed = \KartsNMS\Data\Store\Rrd::fixedSafeDescr($sensor['sensor_descr'], 28);
