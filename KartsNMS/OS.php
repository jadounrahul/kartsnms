...
use KartsNMS\Interfaces\Discovery\StpInstanceDiscovery;
use KartsNMS\Interfaces\Discovery\StpPortDiscovery;
use KartsNMS\Interfaces\Polling\Netstats\IcmpNetstatsPolling;
use KartsNMS\Interfaces\Polling\Netstats\IpForwardNetstatsPolling;
use KartsNMS\Interfaces\Polling\Netstats\IpNetstatsPolling;
use KartsNMS\Interfaces\Polling\Netstats\SnmpNetstatsPolling;
use KartsNMS\Interfaces\Polling\Netstats\TcpNetstatsPolling;
use KartsNMS\Interfaces\Polling\Netstats\UdpNetstatsPolling;
use KartsNMS\Interfaces\Polling\StpInstancePolling;
use KartsNMS\Interfaces\Polling\StpPortPolling;
use KartsNMS\OS\Generic;
use KartsNMS\OS\Traits\BridgeMib;
use KartsNMS\OS\Traits\HostResources;
use KartsNMS\OS\Traits\NetstatsPolling;
use KartsNMS\OS\Traits\ResolvesPortIds;
use KartsNMS\OS\Traits\UcdResources;
use KartsNMS\OS\Traits\YamlMempoolsDiscovery;
use KartsNMS\OS\Traits\YamlOSDiscovery;
    ...
    UdpNetstatsPolling
{
    ...
    public static function make(array &$device): OS
    {
        if (isset($device['os'])) {
            ...
            \KartsNMS\Util\OS::loadDefinition($device['os']);
            $device['os_group'] = Config::get("os.{$device['os']}.group");

            $class = StringHelpers::toClass($device['os'], 'KartsNMS\\OS\\');
            ...
            if ($os_group = Config::get("os.{$device['os']}.group")) {
                $class = StringHelpers::toClass($os_group, 'KartsNMS\\OS\\Shared\\');
