...
$self="/opt/kartsnms/scripts/watchmaillog/watchmaillog.sh";			# Location of this script
$counterfile="/opt/kartsnms/scripts/watchmaillog/watchmaillog_counters";	# Location to store the counter file
$resetfile="/opt/kartsnms/scripts/watchmaillog/watchmaillog_reset";		# Location of the reset counter flag file
