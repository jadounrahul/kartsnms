...
* Updated DataDomain MIB, Added DataDomain Storage poller and discovery ([#9270](https://github.com/jadounrahul/kartsnms/pull/9270)) - [acl](https://github.com/acl)
...
* Don't update ospf stats if there are none. ([#9133](https://github.com/jadounrahul/kartsnms/pull/9133)) - [murrant](https://github.com/murrant)
...
* Syslog fixes ([#9246](https://github.com/jadounrahul/kartsnms/pull/9246)) - [murrant](https://github.com/murrant)
* Disable used rules in template map for select them ([#9212](https://github.com/jadounrahul/kartsnms/pull/9212)) - [TheGreatDoc](https://github.com/TheGreatDoc)
* Update syslog display and backend ([#9228](https://github.com/jadounrahul/kartsnms/pull/9228)) - [murrant](https://github.com/murrant)
* Fixed edit dashboard permissions + moved to toastr ([#9236](https://github.com/jadounrahul/kartsnms/pull/9236)) - [TheGreatDoc](https://github.com/TheGreatDoc)
...
* Fixed format for snmpd configuration step ([#9203](https://github.com/jadounrahul/kartsnms/pull/9203)) - [TheGreatDoc](https://github.com/TheGreatDoc)
...
* Update Alerts widget - Also sort by timestamp, after sorting/grouping by severity. ([#8977](https://github.com/jadounrahul/kartsnms/pull/8977)) - [dsgagi](https://github.com/dsgagi)
...
* Fortinet FortiWeb Basic Support ([#8654](https://github.com/jadounrahul/kartsnms/pull/8654)) - [Rosiak](https://github.com/Rosiak)
...
* Added detection for HWG Poseidon 4002 ([#8593](https://github.com/jadounrahul/kartsnms/pull/8593))
...
* Added Oxidized reload node list button ([#8375](https://github.com/jadounrahul/kartsnms/issues/8375))
* Added docs link to about page ([#8397](https://github.com/jadounrahul/kartsnms/issues/8397))
* Active Directory: filter disabled users, allow nested group membership for AD auth ([#8222](https://github.com/jadounrahul/kartsnms/issues/8222))
* Added borderless fullscreen geographical map, with just the nodes. ([#8337](https://github.com/jadounrahul/kartsnms/issues/8337))
* Improved LDAP filters for getUserlist and getUserlevel ([#8398](https://github.com/jadounrahul/kartsnms/issues/8398))
* Added LDAP debug output ([#8434](https://github.com/jadounrahul/kartsnms/issues/8434))
* LDAP fall back to slow search if memberof is missing ([#8491](https://github.com/jadounrahul/kartsnms/issues/8491))
* Allow full search on devices page ([#8364](https://github.com/jadounrahul/kartsnms/issues/8364))

#### Alerting
* Added a irc_alert_short option to only send the alert title ([#8312](https://github.com/jadounrahul/kartsnms/issues/8312))
* Added Philips Hue as transport ([#8320](https://github.com/jadounrahul/kartsnms/issues/8320))
* Added two html alert template examples ([#8360](https://github.com/jadounrahul/kartsnms/issues/8360))
* Added alert_id to alerts for templates ([#8368](https://github.com/jadounrahul/kartsnms/issues/8368))
* Added new alert rule builder UI ([#8293](https://github.com/jadounrahul/kartsnms/issues/8293))
* Added support for disabling recovery notifications ([#8430](https://github.com/jadounrahul/kartsnms/issues/8430))
* Change the default alert delay to 1m ([#8462](https://github.com/jadounrahul/kartsnms/issues/8462))

#### Documentation
* Use single quotes in example SNMP community per issue 8342 ([#8348](https://github.com/jadounrahul/kartsnms/issues/8348))
* Update SNMP-Configuration-Examples.md to add VMWare example ([#8381](https://github.com/jadounrahul/kartsnms/issues/8381))

#### Misc
* Improve LDAP filter in the getUserlist() function ([#8253](https://github.com/jadounrahul/kartsnms/issues/8253))
* Created check_graylog.inc.php service file ([#8334](https://github.com/jadounrahul/kartsnms/issues/8334))
* Created check_haproxy.inc.php service file ([#8412](https://github.com/jadounrahul/kartsnms/issues/8412))
* Module tests update: per module output, only store modules data that are run ([#8355](https://github.com/jadounrahul/kartsnms/issues/8355))
* Updated APC PowerNet-MIB ([#8377](https://github.com/jadounrahul/kartsnms/issues/8377))
* Print mysql errors in debug output ([#8414](https://github.com/jadounrahul/kartsnms/issues/8414))
* Use custom phpcs ruleset for KartsNMS ([#8418](https://github.com/jadounrahul/kartsnms/issues/8418))
* Updating the mibs file from vmware ([#8388](https://github.com/jadounrahul/kartsnms/issues/8388))
* Small improvement to per port polling (speed boost) ([#8431](https://github.com/jadounrahul/kartsnms/issues/8431))
* Fixed validation sql for primary keys and first columns ([#8453](https://github.com/jadounrahul/kartsnms/issues/8453))
* Added ifAlias to tag influxdb port data ([#8461](https://github.com/jadounrahul/kartsnms/issues/8461))
* Bumping CISCO-PRODUCTS-MIB to newest release ([#8483](https://github.com/jadounrahul/kartsnms/issues/8483))
* Updated and improved manage_bills.php script ([#8467](https://github.com/jadounrahul/kartsnms/issues/8467))
...
#### Features
* Added ironware syslog notify code ([#8268](https://github.com/jadounrahul/kartsnms/issues/8268))
* Copy all email alerts to default contact ([#8178](https://github.com/jadounrahul/kartsnms/issues/8178))
* Added GateOne Link ([#8189](https://github.com/jadounrahul/kartsnms/pull/8189))
* Added ironware syslog notify code ([#8268](https://github.com/jadounrahul/kartsnms/pull/8268))

#### Bugfixes
* Switch detached head for daily updates ([#8194](https://github.com/jadounrahul/kartsnms/issues/8194))
* Fixed arp-tables updates ([#8180](https://github.com/jadounrahul/kartsnms/issues/8180))
* Fixed FusionSwitch portname for sensors ([#8188](https://github.com/jadounrahul/kartsnms/issues/8188))
* Fixed cbgp peers data on some devices ([#8208](https://github.com/jadounrahul/kartsnms/pull/8208))
* Awplus fix cpu ([#8215](https://github.com/jadounrahul/kartsnms/pull/8215))
* Fixed linkify to work with with ip addresses ([#8226](https://github.com/jadounrahul/kartsnms/pull/8226))
* Changed e-mail validation TLD max length to 18 ([#8236](https://github.com/jadounrahul/kartsnms/pull/8236))
* Fixed the HTML Purifier config so allowed values work ([#8239](https://github.com/jadounrahul/kartsnms/pull/8239))
* Fixed issues with new config init ([#8242](https://github.com/jadounrahul/kartsnms/pull/8242))
* Mitigate Cisco IOS 15 Stack State Issue ([#8256](https://github.com/jadounrahul/kartsnms/pull/8256))
* Fix bgp peers discovery cleanup ([#8263](https://github.com/jadounrahul/kartsnms/pull/8263))
* Fixed Dell N1548 CPU graphs ([#8280](https://github.com/jadounrahul/kartsnms/pull/8280))

#### Documentation
* Changed err-msg to message for API docs ([#8182](https://github.com/jadounrahul/kartsnms/issues/8182))
* Fix for syslog-ng config in the docs ([#8160](https://github.com/jadounrahul/kartsnms/issues/8160))

#### Refactoring
* Removed Unused Billing PDF reports ([#8235](https://github.com/jadounrahul/kartsnms/issues/8235))
* Update awplus to new processor discovery ([#8204](https://github.com/jadounrahul/kartsnms/issues/8204))
* Major Processors rewrite ([#8066](https://github.com/jadounrahul/kartsnms/issues/8066))
* Remove composer deps from the repository ([#6920](https://github.com/jadounrahul/kartsnms/pull/6920))
* Share code between all mysql based authorizers ([#8174](https://github.com/jadounrahul/kartsnms/pull/8174))
* Use more secure password hashes ([#8213](https://github.com/jadounrahul/kartsnms/pull/8213))
* Adding invalid hostnames is no longer fatal ([#8233](https://github.com/jadounrahul/kartsnms/pull/8233))
* Correct unix socket handling to match poller-wrapper ([#8214](https://github.com/jadounrahul/kartsnms/pull/8214))
* Move config loading into the Config class ([#8100](https://github.com/jadounrahul/kartsnms/pull/8100))
* Generic snmp_translate() function ([#8156](https://github.com/jadounrahul/kartsnms/pull/8156))

#### Devices
* Added support for ScreenOS arp tables ([#8273](https://github.com/jadounrahul/kartsnms/issues/8273))
* Added support for OpenBSD PF states ([#8211](https://github.com/jadounrahul/kartsnms/issues/8211))
* Added support for F5 GTM ([#8161](https://github.com/jadounrahul/kartsnms/issues/8161))
* Added support for Airos CPU, GPS, and Temp ([#8203](https://github.com/jadounrahul/kartsnms/pull/8203))
* Updated support for XOS X480 and X650 desc and tests ([#8206](https://github.com/jadounrahul/kartsnms/pull/8206))
* Updated Cisco Processor support ([#8216](https://github.com/jadounrahul/kartsnms/pull/8216))
* Added OPNsense support ([#8199](https://github.com/jadounrahul/kartsnms/pull/8199))
* Updated StoneOs support ([#8155](https://github.com/jadounrahul/kartsnms/pull/8155))
* Added Allied Telesis Environmental Monitoring ([#8140](https://github.com/jadounrahul/kartsnms/pull/8140))
* Update support for Brocade G620 description ([#8250](https://github.com/jadounrahul/kartsnms/pull/8250))
* Added CeraOS wireless sensors ([#8167](https://github.com/jadounrahul/kartsnms/pull/8167))

#### WebUI
* Updated jquery_lazyload ([#8287](https://github.com/jadounrahul/kartsnms/issues/8287))
* Updated datetime lib ([#8288](https://github.com/jadounrahul/kartsnms/pull/8288))
* Allow sorting by toner and searching ([#8247](https://github.com/jadounrahul/kartsnms/issues/8247))
* Updated vis js and moment js ([#8240](https://github.com/jadounrahul/kartsnms/issues/8240))
* Added sysNames to pulldowns and the main page ([#8137](https://github.com/jadounrahul/kartsnms/issues/8137))
* Adding invalid hostnames is no longer fatal. ([#8233](https://github.com/jadounrahul/kartsnms/issues/8233))
* Allow administrators to edit devices sysName ([#8149](https://github.com/jadounrahul/kartsnms/pull/8149))
* Allow frameborder attribute in notes widget ([#8219](https://github.com/jadounrahul/kartsnms/pull/8219))
* Updated vis js and moment js ([#8240](https://github.com/jadounrahul/kartsnms/pull/8240))

#### API
* Added Billing Graphs & Data ([#8245](https://github.com/jadounrahul/kartsnms/issues/8245))
* Added History to Billing API Functions ([#8209](https://github.com/jadounrahul/kartsnms/pull/8209))

#### Alerting
* Case insensitive alert rule searching ([#8231](https://github.com/jadounrahul/kartsnms/pull/8231))
* Updated email subject for failed updates to include hostname ([#8258](https://github.com/jadounrahul/kartsnms/pull/8258))
* Set Content-type header in the API transport if the text to be sent is valid JSON ([#8282](https://github.com/jadounrahul/kartsnms/pull/8282))
---
...
#### Features
* Added powerdns dnsdist application ([#7987](https://github.com/jadounrahul/kartsnms/issues/7987))
* Added ZFS support for FreeBSD ([#7938](https://github.com/jadounrahul/kartsnms/pull/7938))
* Added snmp_getnext_multio() function ([#8052](https://github.com/jadounrahul/kartsnms/pull/8052))
* Clear OS defs cache on poller/discovery debug ([#8061](https://github.com/jadounrahul/kartsnms/pull/8061))
* Script to rename mibs to proper names ([#8068](https://github.com/jadounrahul/kartsnms/pull/8068))

#### Bugfixes
* daily.sh Updated to resolve release version issues ([#8172](https://github.com/jadounrahul/kartsnms/issues/8172))
* Make consistent with other authorisers ([#8151](https://github.com/jadounrahul/kartsnms/issues/8151))
* Pushover message fix to enable templates ([#8118](https://github.com/jadounrahul/kartsnms/issues/8118))
* Bgp-peers junos empty afi-safi names ([#8083](https://github.com/jadounrahul/kartsnms/issues/8083))
* Fixed the default fping config + changed variable name ([#8060](https://github.com/jadounrahul/kartsnms/issues/8060))
* Override -H for check_load service. Fixed backslash escaping. ([#8020](https://github.com/jadounrahul/kartsnms/issues/8020))
* Fix can't find CPQHOST-MIB ([#8024](https://github.com/jadounrahul/kartsnms/issues/8024))
* Bgp-peers add missing os junos safi values ([#8018](https://github.com/jadounrahul/kartsnms/issues/8018))
* Cisco-vrf discovery for device os junos ([#8009](https://github.com/jadounrahul/kartsnms/issues/8009))
* Stop stripping html tages from snmp creds ([#7951](https://github.com/jadounrahul/kartsnms/pull/7951))
* Fixed bugs in bgp-peers poller ([#7976](https://github.com/jadounrahul/kartsnms/pull/7976))
* Fix mark all unread notifications ([#7999](https://github.com/jadounrahul/kartsnms/pull/7999))
* Fix deletion of services + select query ([#8030](https://github.com/jadounrahul/kartsnms/pull/8030))
* Moved sysDescr snmp call to snmp_get_multi_oid() in core poller ([#8062](https://github.com/jadounrahul/kartsnms/pull/8062))
* Fixed bad queries for top device widget ([#8105](https://github.com/jadounrahul/kartsnms/pull/8105))
* Stop including disabled ports in traffic overview ([#8107](https://github.com/jadounrahul/kartsnms/pull/8107))
* Specify table name for list_devices API call ([#8132](https://github.com/jadounrahul/kartsnms/pull/8132))
* Fixed Palo Alto HA alert rule ([#8138](https://github.com/jadounrahul/kartsnms/pull/8138))
* Fixed arp table duplicates ([#8147](https://github.com/jadounrahul/kartsnms/pull/8147))
* Fixed normal user access to performance tab ([#8150](https://github.com/jadounrahul/kartsnms/pull/8150))
* Changed is_file() to rrdtool_check_rrd_exists() ([#8152](https://github.com/jadounrahul/kartsnms/pull/8152))

#### Documentation
* Emphasize snmpsim is required for most tests ([#8059](https://github.com/jadounrahul/kartsnms/issues/8059))
* Doc api fixes ([#7950](https://github.com/jadounrahul/kartsnms/issues/7950))
* Added ports purge to cleanup options ([#7970](https://github.com/jadounrahul/kartsnms/pull/7970))

#### Refactoring
* Moved routeros sensors to yaml + fixed divisors ([#7946](https://github.com/jadounrahul/kartsnms/issues/7946))
* Remove all old style snmp calls ([#7924](https://github.com/jadounrahul/kartsnms/issues/7924))
* Fail2ban update and removal of FW checking ([#7936](https://github.com/jadounrahul/kartsnms/pull/7936))
* Refactor freeradius appplication metrics ([#8002](https://github.com/jadounrahul/kartsnms/pull/8002))
* Move ignore_storage call to discover_storage ([#7973](https://github.com/jadounrahul/kartsnms/pull/7973))
* Updated poller/discovery to use numeric sysObjectID ([#7922](https://github.com/jadounrahul/kartsnms/pull/7922))
* Move installs to php53 branch for php version < 5.6.4 ([#8042](https://github.com/jadounrahul/kartsnms/pull/8042))
* Rename cisco-vrf to vrf and enabled junos ([#8033](https://github.com/jadounrahul/kartsnms/pull/8033))
* Updated BGP Peers ([#7972](https://github.com/jadounrahul/kartsnms/pull/7972))

#### Devices
* Added Support for cambium PTP 300, 500, 600 and 800 ([#7998](https://github.com/jadounrahul/kartsnms/issues/7998))
* Added support for ArbOS ([#8055](https://github.com/jadounrahul/kartsnms/issues/8055))
* Added processor and mempools for EdgeCore switch ([#7850](https://github.com/jadounrahul/kartsnms/issues/7850))
* Updated Cisco ACS Detection ([#8013](https://github.com/jadounrahul/kartsnms/issues/8013))
* Added Rittal IT Chiller / Carel pCOweb card ([#7826](https://github.com/jadounrahul/kartsnms/issues/7826))
* Added cyberpower RMCARD 202 Support ([#7964](https://github.com/jadounrahul/kartsnms/issues/7964))
* Added additional detection for CyberPower devices ([#7931](https://github.com/jadounrahul/kartsnms/issues/7931))
* Added further detection for Sophos UTM devices ([#7953](https://github.com/jadounrahul/kartsnms/issues/7953))
* Added Cambium cnPilot Support ([#7898](https://github.com/jadounrahul/kartsnms/issues/7898))
* Added more sensor support for RouterOS (Mikrotik) + Test data ([#7930](https://github.com/jadounrahul/kartsnms/issues/7930))
* Added Checkpoint Gaia Sensor ([#8088](https://github.com/jadounrahul/kartsnms/issues/8088))
* Added Dell iDRAC Global System Sensor ([#8012](https://github.com/jadounrahul/kartsnms/pull/8012))
* Added CheckPoint SecurePlatform support ([#8000](https://github.com/jadounrahul/kartsnms/pull/8000))
* Fixed AirOS version and Hardware ([#8034](https://github.com/jadounrahul/kartsnms/pull/8034))
* Fixed UniFi AP hardware and firmware revision ([#8005](https://github.com/jadounrahul/kartsnms/pull/8005))
* Added Hillstone StoneOS detection ([#7982](https://github.com/jadounrahul/kartsnms/pull/7982))
* Added Allied Telesis CPU support ([#8111](https://github.com/jadounrahul/kartsnms/pull/8111))
* Updated legacy Allied Telesis hardware support ([#8071](https://github.com/jadounrahul/kartsnms/pull/8071))
* Added EER and Water Florw Rate for Rittal Chillers ([#8104](https://github.com/jadounrahul/kartsnms/pull/8104))
* Added memory and temp polling for Dlink ([#8076](https://github.com/jadounrahul/kartsnms/pull/8076))
* Added Hardware/Version/Serial support for Synology ([#8087](https://github.com/jadounrahul/kartsnms/pull/8087))
* Updated hardware for certain awplus devices ([#8123](https://github.com/jadounrahul/kartsnms/pull/8123))
* Updated FortiManager support ([#8102](https://github.com/jadounrahul/kartsnms/pull/8102))
* Added suspended state for panos ([#8125](https://github.com/jadounrahul/kartsnms/pull/8125))

#### WebUI
* Added back devices sort by status ([#8103](https://github.com/jadounrahul/kartsnms/issues/8103))
* Small graylog cleanup ([#8057](https://github.com/jadounrahul/kartsnms/issues/8057))
* Small eventlog cleanup ([#8056](https://github.com/jadounrahul/kartsnms/issues/8056))
* Added OpenWRT icon ([#8054](https://github.com/jadounrahul/kartsnms/issues/8054))
* Devices header cleanup ([#8039](https://github.com/jadounrahul/kartsnms/issues/8039))
* Added validation for Oxidized API URL config ([#7978](https://github.com/jadounrahul/kartsnms/issues/7978))
* Wireless pages refresh ([#7836](https://github.com/jadounrahul/kartsnms/issues/7836))
* HPMSM added CPU,Memory to Overview ([#7949](https://github.com/jadounrahul/kartsnms/issues/7949))
* Added Single server details widget ([#7923](https://github.com/jadounrahul/kartsnms/issues/7923))
* Improved Services page ([#7628](https://github.com/jadounrahul/kartsnms/pull/7628))
* Improved Alerts page ([#7765](https://github.com/jadounrahul/kartsnms/pull/7628))
* Improved Eventlog page ([#7793](https://github.com/jadounrahul/kartsnms/pull/7793))
* Improved Syslog page ([#7796](https://github.com/jadounrahul/kartsnms/pull/7796))
* Improved Devices page ([#7809](https://github.com/jadounrahul/kartsnms/pull/7809))
* Improved Ports page ([#7827](https://github.com/jadounrahul/kartsnms/pull/7827))
* Improved Graylog page ([#7832](https://github.com/jadounrahul/kartsnms/pull/7832))
* Improved Health / Sensors page ([#7834](https://github.com/jadounrahul/kartsnms/pull/7834))
* Improved Wireless page ([#7836](https://github.com/jadounrahul/kartsnms/pull/7836))
* Improved Applications page ([#7994](https://github.com/jadounrahul/kartsnms/pull/7994))
* Added Oxidized config validator ([#7983](https://github.com/jadounrahul/kartsnms/pull/7983))
* Added settings validations ([#8037](https://github.com/jadounrahul/kartsnms/pull/8037))

#### API
* Added add_service_for_host endpoint to API ([#8113](https://github.com/jadounrahul/kartsnms/issues/8113))
* Added dependency info for devices/device api calls ([#8058](https://github.com/jadounrahul/kartsnms/issues/8058))
* Added 404 fallback for bad / invalid calls ([#7952](https://github.com/jadounrahul/kartsnms/pull/7952))
* Added routing and resources API calls ([#8017](https://github.com/jadounrahul/kartsnms/pull/8017))

#### Alerting
* Updated Pushover to use templates ([#8118](https://github.com/jadounrahul/kartsnms/pull/8118))
