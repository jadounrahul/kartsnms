...
<head>
    ...
    <base href="{{ KartsNMS\Config::get('base_url') }}">
    <meta http-equiv="content-type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    @if(!KartsNMS\Config::get('favicon', false))
    ...
    @else
        <link rel="shortcut icon" href="{{ KartsNMS\Config::get('favicon') }}">
    @endif
    ...
    <link href="{{ asset(KartsNMS\Config::get('stylesheet', 'css/styles.css')) }}?ver=20230928" rel="stylesheet">
    <link href="{{ asset('css/' . KartsNMS\Config::get('applied_site_style', 'light') . '.css?ver=632417643') }}" rel="stylesheet">
    @foreach(KartsNMS\Config::get('webui.custom_css', []) as $custom_css)
    ...
    <script src="{{ asset('js/kartsnms.js?ver=07312023') }}"></script>
    ...
    <script>
        // Apply color scheme
        if ('{{ KartsNMS\Config::get('applied_site_style') }}' === 'dark') {
