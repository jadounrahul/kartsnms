        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="Edit-transport">Alert Transport Groups :: <a target="_blank" href="https://docs.kartsnms.org/Alerting/">Docs <i class="fa fa-book fa-1x"></i></a> </h5>
                </div>
