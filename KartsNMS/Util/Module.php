...
use KartsNMS\Config;
use KartsNMS\Modules\LegacyModule;
use KartsNMS\Polling\ModuleStatus;

class Module
{
    public static function fromName(string $name): \KartsNMS\Interfaces\Module
    {
        $module_class = StringHelpers::toClass($name, '\\KartsNMS\\Modules\\');
    ...
    {
        return class_exists(StringHelpers::toClass($module, '\\KartsNMS\\Modules\\'))
