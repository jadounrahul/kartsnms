...
namespace KartsNMS\Validations\DistributedPoller;

use KartsNMS\Config;
use KartsNMS\ValidationResult;
use KartsNMS\Validations\Rrd\CheckRrdcachedConnectivity;

class CheckRrdcached implements \KartsNMS\Interfaces\Validation
{
    /**
     * @inheritDoc
     */
